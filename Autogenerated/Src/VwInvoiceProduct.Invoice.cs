namespace Terrasoft.Configuration
{
	...
	public class VwInvoiceProductSchema : Terrasoft.Configuration.InvoiceProductSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwInvoiceProduct_InvoiceEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwInvoiceProduct_InvoiceEventsProcess<TEntity> : Terrasoft.Configuration.InvoiceProduct_ProductCatalogueInInvoiceEventsProcess<TEntity> where TEntity : VwInvoiceProduct
	{
