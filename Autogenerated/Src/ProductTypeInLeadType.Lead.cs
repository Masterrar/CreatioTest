namespace Terrasoft.Configuration
{
	...
	public class ProductTypeInLeadTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProductTypeInLeadType_LeadEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProductTypeInLeadType_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ProductTypeInLeadType
	{
