namespace Terrasoft.Configuration
{
	...
	public class ServiceItemFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateServiceItemFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateServiceItemFileEventsProcessSchema() {
			var schema = new ServiceItemFileEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ServiceItemFile_SLMEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ServiceItemFile_SLMEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ServiceItemFile
	{
	...
	#region Class: ServiceItemFileEventsProcessSchema

	/// <exclude/>
	public class ServiceItemFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public ServiceItemFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ServiceItemFileEventsProcessSchema(ServiceItemFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ServiceItemFile_SLMEventsProcess";
			UId = new Guid("8034bdd8-8a62-42ac-ab35-ec7f5be7a7f3");
			CreatedInPackageId = new Guid("ffa69c6a-c8bb-4a61-bc00-b0bcd40a9862");
		...
		public override object Clone() {
			return new ServiceItemFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("8034bdd8-8a62-42ac-ab35-ec7f5be7a7f3"));
		}
