namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OrganizationProperty_SSPEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : OrganizationProperty
	{
