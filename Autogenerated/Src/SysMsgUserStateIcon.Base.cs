namespace Terrasoft.Configuration
{
	...
	public class SysMsgUserStateIconSchema : Terrasoft.Configuration.BaseImageLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysMsgUserStateIcon_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysMsgUserStateIcon_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseImageLookup_BaseEventsProcess<TEntity> where TEntity : SysMsgUserStateIcon
	{
