namespace Terrasoft.Configuration
{
	...
	public class ReleaseTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateReleaseTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateReleaseTagEventsProcessSchema() {
			var schema = new ReleaseTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ReleaseTag_ReleaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ReleaseTag_ReleaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ReleaseTag
	{
	...
	#region Class: ReleaseTagEventsProcessSchema

	/// <exclude/>
	public class ReleaseTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public ReleaseTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ReleaseTagEventsProcessSchema(ReleaseTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ReleaseTag_ReleaseEventsProcess";
			UId = new Guid("8bcb2ae9-d72a-4b99-9512-813a919c1258");
			CreatedInPackageId = new Guid("dfe2c6b5-61e8-4e57-95ae-a3c34fa0908f");
		...
		public override object Clone() {
			return new ReleaseTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("8bcb2ae9-d72a-4b99-9512-813a919c1258"));
		}
