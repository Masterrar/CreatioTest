namespace Terrasoft.Configuration
{
	...
	public class VwSystemUsersSchema : Terrasoft.Configuration.VwSystemUsers_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwSystemUsersEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwSystemUsersEventsProcessSchema() {
			var schema = new VwSystemUsersEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwSystemUsersEventsProcessSchema

	/// <exclude/>
	public class VwSystemUsersEventsProcessSchema : Terrasoft.Configuration.VwSystemUsers_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public VwSystemUsersEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwSystemUsersEventsProcessSchema(VwSystemUsersEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwSystemUsers_PRMOrderEventsProcess";
			UId = new Guid("3c516876-c776-482f-a5fa-020fe2ac4d73");
			CreatedInPackageId = new Guid("76eace8e-4a48-486b-bf04-de18fe06b0a2");
		...
		public override object Clone() {
			return new VwSystemUsersEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("3c516876-c776-482f-a5fa-020fe2ac4d73"));
		}
