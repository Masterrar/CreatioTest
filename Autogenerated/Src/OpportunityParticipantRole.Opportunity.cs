namespace Terrasoft.Configuration
{
	...
	public class OpportunityParticipantRoleSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new OpportunityParticipantRole_OpportunityEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class OpportunityParticipantRole_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OpportunityParticipantRole
	{
