namespace Terrasoft.Configuration
{
	...
	public class ContactTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ContactType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ContactType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ContactType
	{
