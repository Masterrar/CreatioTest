namespace Terrasoft.Configuration
{
	...
	public class SysStoringObjectStateSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysStoringObjectState_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysStoringObjectState_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysStoringObjectState
	{
