namespace Terrasoft.Configuration
{
	...
	public class BulkEmailInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBulkEmailInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBulkEmailInTagEventsProcessSchema() {
			var schema = new BulkEmailInTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BulkEmailInTag_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BulkEmailInTag_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : BulkEmailInTag
	{
	...
	#region Class: BulkEmailInTagEventsProcessSchema

	/// <exclude/>
	public class BulkEmailInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public BulkEmailInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BulkEmailInTagEventsProcessSchema(BulkEmailInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BulkEmailInTag_MarketingCampaignEventsProcess";
			UId = new Guid("16f330dc-627a-420c-ba84-6b5ba549557c");
			CreatedInPackageId = new Guid("b7874c9a-6e65-41ca-b21f-5fb1f6a22855");
		...
		public override object Clone() {
			return new BulkEmailInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("16f330dc-627a-420c-ba84-6b5ba549557c"));
		}
