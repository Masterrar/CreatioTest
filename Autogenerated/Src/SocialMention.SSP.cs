namespace Terrasoft.Configuration
{
	...
	public class SocialMentionSchema : Terrasoft.Configuration.SocialMention_ESN_TerrasoftSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SocialMention_SSPEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SocialMention_SSPEventsProcess<TEntity> : Terrasoft.Configuration.SocialMention_ESNEventsProcess<TEntity> where TEntity : SocialMention
	{
