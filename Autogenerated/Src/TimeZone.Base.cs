namespace Terrasoft.Configuration
{
	...
	public class TimeZoneSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new TimeZone_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class TimeZone_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : TimeZone
	{
