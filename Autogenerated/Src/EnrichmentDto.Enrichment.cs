namespace Terrasoft.Configuration.EnrichmentDto
{
	...
	#region Class: NewtonsoftBasedSerializer

	/// <summary>
	/// Serializer for RestSharper client, applies DataMember attribute settings.
	/// </summary>
	public class NewtonsoftBasedSerializer : RestSharp.Serializers.ISerializer
	{
		...
		/// <summary>
		/// Creates instance of <see cref="NewtonsoftBasedSerializer"/> and setups default content encoding to Json.
		/// </summary>
		public NewtonsoftBasedSerializer() {
