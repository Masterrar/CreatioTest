namespace Terrasoft.Configuration
{
	...
	public class UnitSchema : Terrasoft.Configuration.Unit_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateUnitEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateUnitEventsProcessSchema() {
			var schema = new UnitEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: UnitEventsProcessSchema

	/// <exclude/>
	public class UnitEventsProcessSchema : Terrasoft.Configuration.Unit_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public UnitEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public UnitEventsProcessSchema(UnitEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Unit_PRMOrderEventsProcess";
			UId = new Guid("e468f7b1-60cd-4dfc-9f8d-e727a147b404");
		...
		public override object Clone() {
			return new UnitEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e468f7b1-60cd-4dfc-9f8d-e727a147b404"));
		}
