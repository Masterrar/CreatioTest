namespace Terrasoft.Configuration
{
	...
	public class LookupTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new LookupTag_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class LookupTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : LookupTag
	{
