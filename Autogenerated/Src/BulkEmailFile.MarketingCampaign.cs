namespace Terrasoft.Configuration
{
	...
	public class BulkEmailFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBulkEmailFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBulkEmailFileEventsProcessSchema() {
			var schema = new BulkEmailFileEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BulkEmailFile_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BulkEmailFile_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : BulkEmailFile
	{
	...
	#region Class: BulkEmailFileEventsProcessSchema

	/// <exclude/>
	public class BulkEmailFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public BulkEmailFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BulkEmailFileEventsProcessSchema(BulkEmailFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BulkEmailFile_MarketingCampaignEventsProcess";
			UId = new Guid("f33b1dea-c612-4e5e-9a76-22688e216fa6");
		...
		public override object Clone() {
			return new BulkEmailFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f33b1dea-c612-4e5e-9a76-22688e216fa6"));
		}
