namespace Terrasoft.Configuration
{
	...
	public class SiteEventTypeFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSiteEventTypeFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSiteEventTypeFileEventsProcessSchema() {
			var schema = new SiteEventTypeFileEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SiteEventTypeFile_EventTrackingEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SiteEventTypeFile_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : SiteEventTypeFile
	{
	...
	#region Class: SiteEventTypeFileEventsProcessSchema

	/// <exclude/>
	public class SiteEventTypeFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public SiteEventTypeFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SiteEventTypeFileEventsProcessSchema(SiteEventTypeFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SiteEventTypeFile_EventTrackingEventsProcess";
			UId = new Guid("cfce18b6-2110-4fa5-8889-66a288c7b0f4");
			CreatedInPackageId = new Guid("8a6b5719-da97-4634-8f04-4375bc29ffcf");
		...
		public override object Clone() {
			return new SiteEventTypeFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("cfce18b6-2110-4fa5-8889-66a288c7b0f4"));
		}
