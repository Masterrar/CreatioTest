namespace Terrasoft.Configuration
{
	...
	public class ContractInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ContractInFolder_CoreContractsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ContractInFolder_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ContractInFolder
	{
