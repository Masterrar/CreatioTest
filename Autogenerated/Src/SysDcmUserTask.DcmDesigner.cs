namespace Terrasoft.Configuration
{
	...
	public class SysDcmUserTaskSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysDcmUserTask_DcmDesignerEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysDcmUserTask_DcmDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysDcmUserTask
	{
