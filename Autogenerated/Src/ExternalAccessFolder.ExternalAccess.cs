namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ExternalAccessFolder_ExternalAccessEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ExternalAccessFolder
	{
