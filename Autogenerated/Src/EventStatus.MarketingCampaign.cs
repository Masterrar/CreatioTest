namespace Terrasoft.Configuration
{
	...
	public class EventStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEventStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEventStatusEventsProcessSchema() {
			var schema = new EventStatusEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new EventStatus_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class EventStatus_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EventStatus
	{
	...
	#region Class: EventStatusEventsProcessSchema

	/// <exclude/>
	public class EventStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public EventStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EventStatusEventsProcessSchema(EventStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EventStatus_MarketingCampaignEventsProcess";
			UId = new Guid("aa9c8003-2884-4c6d-acd6-4855bbced0c0");
			CreatedInPackageId = new Guid("b827f319-d8b8-41a8-9645-da32137f000d");
		...
		public override object Clone() {
			return new EventStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("aa9c8003-2884-4c6d-acd6-4855bbced0c0"));
		}
