namespace Terrasoft.Configuration
{
	...
	public class VwSSPSysAdminUnitSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwSSPSysAdminUnit_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwSSPSysAdminUnit_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : VwSSPSysAdminUnit
	{
