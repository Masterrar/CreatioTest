namespace Terrasoft.Configuration
{
	...
	public class LeadFolderSchema : Terrasoft.Configuration.LeadFolder_Lead_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLeadFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLeadFolderEventsProcessSchema() {
			var schema = new LeadFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: LeadFolderEventsProcessSchema

	/// <exclude/>
	public class LeadFolderEventsProcessSchema : Terrasoft.Configuration.LeadFolder_Lead_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public LeadFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LeadFolderEventsProcessSchema(LeadFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LeadFolder_PRMPortalEventsProcess";
			UId = new Guid("f3ab375f-dc17-4f52-bcb6-6ba2d5cfa2dc");
			CreatedInPackageId = new Guid("0fffc5a3-cd85-4e12-bfdb-f47322f14e3d");
			...
			ParentSchemaUId = new Guid("aade0731-63ae-4f00-b0e8-5fd36e2d1f60");
		...
		public override object Clone() {
			return new LeadFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f3ab375f-dc17-4f52-bcb6-6ba2d5cfa2dc"));
		}
