namespace Terrasoft.Configuration
{
	...
	public class LeadInTag_Lead_TerrasoftSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new LeadInTag_LeadEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class LeadInTag_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : LeadInTag_Lead_Terrasoft
	{
