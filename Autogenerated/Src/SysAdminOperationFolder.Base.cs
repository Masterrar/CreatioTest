namespace Terrasoft.Configuration
{
	...
	public class SysAdminOperationFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysAdminOperationFolder_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysAdminOperationFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : SysAdminOperationFolder
	{
