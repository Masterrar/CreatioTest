namespace Terrasoft.Configuration
{
	...
	public class AccountType_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new AccountType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class AccountType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : AccountType_Base_Terrasoft
	{
