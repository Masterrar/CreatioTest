namespace Terrasoft.Configuration
{
	...
	public class OpportunityInTag_Opportunity_TerrasoftSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new OpportunityInTag_OpportunityEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class OpportunityInTag_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : OpportunityInTag_Opportunity_Terrasoft
	{
