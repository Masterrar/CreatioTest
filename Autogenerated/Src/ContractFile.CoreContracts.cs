namespace Terrasoft.Configuration
{
	...
	public class ContractFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ContractFile_CoreContractsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ContractFile_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ContractFile
	{
