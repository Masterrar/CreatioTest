namespace Terrasoft.Configuration
{
	...
	public class SysEditPageSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysEditPage_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysEditPage_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysEditPage
	{
