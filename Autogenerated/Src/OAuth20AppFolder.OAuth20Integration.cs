namespace Terrasoft.Configuration
{
	...
	public class OAuth20AppFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new OAuth20AppFolder_OAuth20IntegrationEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class OAuth20AppFolder_OAuth20IntegrationEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : OAuth20AppFolder
	{
