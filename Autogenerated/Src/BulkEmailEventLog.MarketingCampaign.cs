namespace Terrasoft.Configuration
{
	...
	public class BulkEmailEventLogSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBulkEmailEventLogEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBulkEmailEventLogEventsProcessSchema() {
			var schema = new BulkEmailEventLogEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public class BulkEmailEventLog_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailEventLog
	{
	...
	#region Class: BulkEmailEventLogEventsProcessSchema

	/// <exclude/>
	public class BulkEmailEventLogEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public BulkEmailEventLogEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BulkEmailEventLogEventsProcessSchema(BulkEmailEventLogEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BulkEmailEventLog_MarketingCampaignEventsProcess";
			UId = new Guid("5d2f432f-2e2a-4ee0-84af-4c74939158a3");
			CreatedInPackageId = new Guid("047a9257-bd59-41e6-8705-ec422d051419");
		...
		public override object Clone() {
			return new BulkEmailEventLogEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("5d2f432f-2e2a-4ee0-84af-4c74939158a3"));
		}
