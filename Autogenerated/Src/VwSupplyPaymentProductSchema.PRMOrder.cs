namespace Terrasoft.Configuration
{
	...
	public class VwSupplyPaymentProductSchema : Terrasoft.Configuration.VwSupplyPaymentProduct_Passport_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwSupplyPaymentProductEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwSupplyPaymentProductEventsProcessSchema() {
			var schema = new VwSupplyPaymentProductEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwSupplyPaymentProductEventsProcessSchema

	/// <exclude/>
	public class VwSupplyPaymentProductEventsProcessSchema : Terrasoft.Configuration.VwSupplyPaymentProduct_Passport_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public VwSupplyPaymentProductEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwSupplyPaymentProductEventsProcessSchema(VwSupplyPaymentProductEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwSupplyPaymentProduct_PRMOrderEventsProcess";
			UId = new Guid("48b56b4c-6d72-48d9-a9f9-88cc3bbc4703");
			CreatedInPackageId = new Guid("e575b496-539f-4b26-8ba5-4be2dab7e3d9");
			...
			ParentSchemaUId = new Guid("4ea7e9d4-ea1c-4a70-a367-ecb6e21886de");
		...
		public override object Clone() {
			return new VwSupplyPaymentProductEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("48b56b4c-6d72-48d9-a9f9-88cc3bbc4703"));
		}
