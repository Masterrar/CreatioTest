namespace Terrasoft.Configuration
{
	...
	public class CommunicationSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Communication_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Communication_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : Communication
	{
