namespace Terrasoft.Configuration
{
	...
	public class FileFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new FileFolder_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class FileFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : FileFolder
	{
