namespace Terrasoft.Configuration
{
	...
	public class SysMsgUserStateReasonSchema : Terrasoft.Configuration.BaseCodeImageLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysMsgUserStateReason_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysMsgUserStateReason_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeImageLookup_BaseEventsProcess<TEntity> where TEntity : SysMsgUserStateReason
	{
