namespace Terrasoft.Configuration
{
	...
	public class VwRecentCallSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwRecentCall_CTIBaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwRecentCall_CTIBaseEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : VwRecentCall
	{
