namespace Terrasoft.Configuration
{
	...
	public class OppContactRole_Opportunity_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new OppContactRole_OpportunityEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class OppContactRole_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OppContactRole_Opportunity_Terrasoft
	{
