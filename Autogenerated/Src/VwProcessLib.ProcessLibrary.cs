namespace Terrasoft.Configuration
{
	...
	public class VwProcessLibSchema : Terrasoft.Configuration.VwSysSchemaInWorkspaceSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwProcessLib_ProcessLibraryEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwProcessLib_ProcessLibraryEventsProcess<TEntity> : Terrasoft.Configuration.VwSysSchemaInWorkspace_BaseEventsProcess<TEntity> where TEntity : VwProcessLib
	{
