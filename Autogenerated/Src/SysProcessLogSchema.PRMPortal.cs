namespace Terrasoft.Configuration
{
	...
	public class SysProcessLogSchema : Terrasoft.Configuration.SysProcessLog_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysProcessLogEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysProcessLogEventsProcessSchema() {
			var schema = new SysProcessLogEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysProcessLogEventsProcessSchema

	/// <exclude/>
	public class SysProcessLogEventsProcessSchema : Terrasoft.Configuration.SysProcessLog_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public SysProcessLogEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysProcessLogEventsProcessSchema(SysProcessLogEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysProcessLog_PRMPortalEventsProcess";
			UId = new Guid("a22663fa-b53d-4830-be84-93970aab5dfa");
			CreatedInPackageId = new Guid("667fe825-207f-46da-8fb7-a082f81fd079");
		...
		public override object Clone() {
			return new SysProcessLogEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a22663fa-b53d-4830-be84-93970aab5dfa"));
		}
