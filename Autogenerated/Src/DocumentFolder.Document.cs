namespace Terrasoft.Configuration
{
	...
	public class DocumentFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DocumentFolder_DocumentEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DocumentFolder_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : DocumentFolder
	{
