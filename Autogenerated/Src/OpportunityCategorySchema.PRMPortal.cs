namespace Terrasoft.Configuration
{
	...
	public class OpportunityCategorySchema : Terrasoft.Configuration.OpportunityCategory_Opportunity_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityCategoryEventsProcessSchema();
		}
	...
	#region Class: OpportunityCategoryEventsProcessSchema

	/// <exclude/>
	public class OpportunityCategoryEventsProcessSchema : Terrasoft.Configuration.OpportunityCategory_Opportunity_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityCategoryEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityCategory_PRMPortalEventsProcess";
			UId = new Guid("d266a455-1ee9-4bdc-9863-c9c0c81fde6c");
			CreatedInPackageId = new Guid("580620fc-064a-4cdc-95d9-80175a4d3b0d");
			...
			ParentSchemaUId = new Guid("79ace4a7-7cbd-4fe7-8c75-302c05a9546a");
		...
		public override object Clone() {
			return new OpportunityCategoryEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("d266a455-1ee9-4bdc-9863-c9c0c81fde6c"));
		}
