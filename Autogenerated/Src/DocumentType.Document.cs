namespace Terrasoft.Configuration
{
	...
	public class DocumentTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DocumentType_DocumentEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DocumentType_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DocumentType
	{
