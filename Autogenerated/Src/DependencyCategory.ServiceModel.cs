namespace Terrasoft.Configuration
{
	...
	public class DependencyCategorySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDependencyCategoryEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDependencyCategoryEventsProcessSchema() {
			var schema = new DependencyCategoryEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DependencyCategory_ServiceModelEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DependencyCategory_ServiceModelEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DependencyCategory
	{
	...
	#region Class: DependencyCategoryEventsProcessSchema

	/// <exclude/>
	public class DependencyCategoryEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public DependencyCategoryEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DependencyCategoryEventsProcessSchema(DependencyCategoryEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DependencyCategory_ServiceModelEventsProcess";
			UId = new Guid("77d3357a-fefa-49a2-9247-aebb3c5d2f68");
			CreatedInPackageId = new Guid("4516643a-023b-4e8c-93a2-5f32ae9ffe7d");
		...
		public override object Clone() {
			return new DependencyCategoryEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("77d3357a-fefa-49a2-9247-aebb3c5d2f68"));
		}
