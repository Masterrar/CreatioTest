namespace Terrasoft.Configuration
{
	...
	public class DCTemplateGroupSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDCTemplateGroupEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDCTemplateGroupEventsProcessSchema() {
			var schema = new DCTemplateGroupEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DCTemplateGroup_DynamicContentEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DCTemplateGroup_DynamicContentEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : DCTemplateGroup
	{
	...
	#region Class: DCTemplateGroupEventsProcessSchema

	/// <exclude/>
	public class DCTemplateGroupEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public DCTemplateGroupEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DCTemplateGroupEventsProcessSchema(DCTemplateGroupEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DCTemplateGroup_DynamicContentEventsProcess";
			UId = new Guid("c32fe3da-4888-4689-b822-956f42aaf16b");
			CreatedInPackageId = new Guid("6814f243-a95c-4904-a4a6-be6dfa209a4e");
		...
		public override object Clone() {
			return new DCTemplateGroupEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c32fe3da-4888-4689-b822-956f42aaf16b"));
		}
