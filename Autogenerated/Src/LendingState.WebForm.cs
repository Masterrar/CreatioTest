namespace Terrasoft.Configuration
{
	...
	public class LendingStateSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new LendingState_WebFormEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class LendingState_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LendingState
	{
