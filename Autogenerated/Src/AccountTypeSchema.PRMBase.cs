namespace Terrasoft.Configuration
{
	...
	public class AccountTypeSchema : Terrasoft.Configuration.AccountType_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAccountTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateAccountTypeEventsProcessSchema() {
			var schema = new AccountTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: AccountTypeEventsProcessSchema

	/// <exclude/>
	public class AccountTypeEventsProcessSchema : Terrasoft.Configuration.AccountType_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public AccountTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public AccountTypeEventsProcessSchema(AccountTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "AccountType_PRMBaseEventsProcess";
			UId = new Guid("c726a818-e9f2-4aa2-a00a-36ae3725bb9d");
			CreatedInPackageId = new Guid("6ffc9a98-f80d-4502-b20f-130286444518");
			...
			ParentSchemaUId = new Guid("348a7891-ed13-4b5f-9e59-c18673ed63b1");
		...
		public override object Clone() {
			return new AccountTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c726a818-e9f2-4aa2-a00a-36ae3725bb9d"));
		}
