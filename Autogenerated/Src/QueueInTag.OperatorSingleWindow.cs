namespace Terrasoft.Configuration
{
	...
	public class QueueInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateQueueInTagEventsProcessSchema();
		}
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new QueueInTag_OperatorSingleWindowEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class QueueInTag_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : QueueInTag
	{
	...
	#region Class: QueueInTagEventsProcessSchema

	/// <exclude/>
	public class QueueInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public QueueInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "QueueInTag_OperatorSingleWindowEventsProcess";
			UId = new Guid("89764b22-9630-43bb-b29e-2c8938f5d357");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new QueueInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("89764b22-9630-43bb-b29e-2c8938f5d357"));
		}
