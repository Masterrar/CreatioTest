namespace Terrasoft.Configuration
{
	...
	public class MktgActivityTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateMktgActivityTagEventsProcessSchema();
		}
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new MktgActivityTag_CampaignPlannerNewEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class MktgActivityTag_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : MktgActivityTag
	{
	...
	#region Class: MktgActivityTagEventsProcessSchema

	/// <exclude/>
	public class MktgActivityTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public MktgActivityTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "MktgActivityTag_CampaignPlannerNewEventsProcess";
			UId = new Guid("95bed90b-e47e-492e-bf39-38d50bf9f91c");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new MktgActivityTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("95bed90b-e47e-492e-bf39-38d50bf9f91c"));
		}
