namespace Terrasoft.Configuration
{
	...
	public class PartnershipInFolderSchema : Terrasoft.Configuration.PartnershipInFolder_PRMBase_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePartnershipInFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePartnershipInFolderEventsProcessSchema() {
			var schema = new PartnershipInFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: PartnershipInFolderEventsProcessSchema

	/// <exclude/>
	public class PartnershipInFolderEventsProcessSchema : Terrasoft.Configuration.PartnershipInFolder_PRMBase_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public PartnershipInFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PartnershipInFolderEventsProcessSchema(PartnershipInFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "PartnershipInFolder_PRMPortalEventsProcess";
			UId = new Guid("c83f97c8-2372-4636-931c-6f9b02b63761");
		...
		public override object Clone() {
			return new PartnershipInFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c83f97c8-2372-4636-931c-6f9b02b63761"));
		}
