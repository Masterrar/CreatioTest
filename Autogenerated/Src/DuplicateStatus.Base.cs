namespace Terrasoft.Configuration
{
	...
	public class DuplicateStatusSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DuplicateStatus_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DuplicateStatus_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : DuplicateStatus
	{
