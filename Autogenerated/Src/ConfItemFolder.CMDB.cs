namespace Terrasoft.Configuration
{
	...
	public class ConfItemFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateConfItemFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateConfItemFolderEventsProcessSchema() {
			var schema = new ConfItemFolderEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ConfItemFolder_CMDBEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ConfItemFolder_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ConfItemFolder
	{
	...
	#region Class: ConfItemFolderEventsProcessSchema

	/// <exclude/>
	public class ConfItemFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public ConfItemFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ConfItemFolderEventsProcessSchema(ConfItemFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ConfItemFolder_CMDBEventsProcess";
			UId = new Guid("a115b06f-7e9d-4da5-9ff9-a145dff00489");
			CreatedInPackageId = new Guid("305fcfca-4160-4398-90a9-d5e84be0ae12");
		...
		public override object Clone() {
			return new ConfItemFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a115b06f-7e9d-4da5-9ff9-a145dff00489"));
		}
