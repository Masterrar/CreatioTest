namespace Terrasoft.Configuration
{
	...
	public class PartnershipFolderSchema : Terrasoft.Configuration.PartnershipFolder_PRMBase_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePartnershipFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePartnershipFolderEventsProcessSchema() {
			var schema = new PartnershipFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: PartnershipFolderEventsProcessSchema

	/// <exclude/>
	public class PartnershipFolderEventsProcessSchema : Terrasoft.Configuration.PartnershipFolder_PRMBase_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public PartnershipFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PartnershipFolderEventsProcessSchema(PartnershipFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "PartnershipFolder_PRMPortalEventsProcess";
			UId = new Guid("1e0229e2-f6c0-4be8-9597-a01cf21ce574");
		...
		public override object Clone() {
			return new PartnershipFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("1e0229e2-f6c0-4be8-9597-a01cf21ce574"));
		}
