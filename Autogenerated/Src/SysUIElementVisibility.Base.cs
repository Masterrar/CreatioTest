namespace Terrasoft.Configuration
{
	...
	public class SysUIElementVisibilitySchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysUIElementVisibility_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysUIElementVisibility_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysUIElementVisibility
	{
