namespace Terrasoft.Configuration
{
	...
	public class MLModelStateSchema : Terrasoft.Configuration.SysCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new MLModelState_MLBaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class MLModelState_MLBaseEventsProcess<TEntity> : Terrasoft.Configuration.SysCodeLookup_BaseEventsProcess<TEntity> where TEntity : MLModelState
	{
