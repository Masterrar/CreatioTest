namespace Terrasoft.Configuration
{
	...
	public class OpportunityCategory_Opportunity_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new OpportunityCategory_OpportunityEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class OpportunityCategory_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OpportunityCategory_Opportunity_Terrasoft
	{
