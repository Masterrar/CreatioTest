namespace Terrasoft.Configuration
{
	...
	public class BulkEmailSplitInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBulkEmailSplitInFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBulkEmailSplitInFolderEventsProcessSchema() {
			var schema = new BulkEmailSplitInFolderEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BulkEmailSplitInFolder_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BulkEmailSplitInFolder_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : BulkEmailSplitInFolder
	{
	...
	#region Class: BulkEmailSplitInFolderEventsProcessSchema

	/// <exclude/>
	public class BulkEmailSplitInFolderEventsProcessSchema : Terrasoft.Configuration.BaseItemInFolderEventsProcessSchema
	{

		#region Constructors: Public

		public BulkEmailSplitInFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BulkEmailSplitInFolderEventsProcessSchema(BulkEmailSplitInFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BulkEmailSplitInFolder_MarketingCampaignEventsProcess";
			UId = new Guid("48e2a553-c47c-492c-9feb-69ad67986f8f");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new BulkEmailSplitInFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("48e2a553-c47c-492c-9feb-69ad67986f8f"));
		}
