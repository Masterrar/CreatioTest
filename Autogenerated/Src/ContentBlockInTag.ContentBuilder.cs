namespace Terrasoft.Configuration
{
	...
	public class ContentBlockInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ContentBlockInTag_ContentBuilderEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ContentBlockInTag_ContentBuilderEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ContentBlockInTag
	{
