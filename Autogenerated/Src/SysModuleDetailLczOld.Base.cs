namespace Terrasoft.Configuration
{
	...
	public class SysModuleDetailLczOldSchema : Terrasoft.Configuration.BaseLczEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysModuleDetailLczOld_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysModuleDetailLczOld_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLczEntity_BaseEventsProcess<TEntity> where TEntity : SysModuleDetailLczOld
	{
