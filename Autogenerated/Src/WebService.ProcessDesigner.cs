namespace Terrasoft.Configuration
{
	...
	public class WebServiceSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new WebService_ProcessDesignerEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class WebService_ProcessDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : WebService
	{
