namespace Terrasoft.Configuration
{
	...
	public class ServiceObjectTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateServiceObjectTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateServiceObjectTypeEventsProcessSchema() {
			var schema = new ServiceObjectTypeEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ServiceObjectType_CaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ServiceObjectType_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ServiceObjectType
	{
	...
	#region Class: ServiceObjectTypeEventsProcessSchema

	/// <exclude/>
	public class ServiceObjectTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ServiceObjectTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ServiceObjectTypeEventsProcessSchema(ServiceObjectTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ServiceObjectType_CaseEventsProcess";
			UId = new Guid("043ea1bb-41dc-465f-bddf-b65d1c17634f");
			CreatedInPackageId = new Guid("e9cdff4a-a92d-4d26-906f-df90167f5485");
		...
		public override object Clone() {
			return new ServiceObjectTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("043ea1bb-41dc-465f-bddf-b65d1c17634f"));
		}
