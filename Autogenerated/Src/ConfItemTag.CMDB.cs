namespace Terrasoft.Configuration
{
	...
	public class ConfItemTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateConfItemTagEventsProcessSchema();
		}
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ConfItemTag_CMDBEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ConfItemTag_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ConfItemTag
	{
	...
	#region Class: ConfItemTagEventsProcessSchema

	/// <exclude/>
	public class ConfItemTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public ConfItemTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ConfItemTag_CMDBEventsProcess";
			UId = new Guid("0bbfd9a2-970d-4b2a-b2c7-4e864fe5abc7");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ConfItemTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0bbfd9a2-970d-4b2a-b2c7-4e864fe5abc7"));
		}
