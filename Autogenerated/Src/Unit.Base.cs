namespace Terrasoft.Configuration
{
	...
	public class Unit_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Unit_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Unit_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : Unit_Base_Terrasoft
	{
