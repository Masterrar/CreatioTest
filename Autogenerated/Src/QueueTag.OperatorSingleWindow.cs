namespace Terrasoft.Configuration
{
	...
	public class QueueTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateQueueTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateQueueTagEventsProcessSchema() {
			var schema = new QueueTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new QueueTag_OperatorSingleWindowEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class QueueTag_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : QueueTag
	{
	...
	#region Class: QueueTagEventsProcessSchema

	/// <exclude/>
	public class QueueTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public QueueTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public QueueTagEventsProcessSchema(QueueTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "QueueTag_OperatorSingleWindowEventsProcess";
			UId = new Guid("5987fcaa-ae7f-4e2e-a9f6-f9b0517f42a0");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new QueueTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("5987fcaa-ae7f-4e2e-a9f6-f9b0517f42a0"));
		}
