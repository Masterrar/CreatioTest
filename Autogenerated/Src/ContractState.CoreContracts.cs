namespace Terrasoft.Configuration
{
	...
	public class ContractStateSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ContractState_CoreContractsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ContractState_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ContractState
	{
