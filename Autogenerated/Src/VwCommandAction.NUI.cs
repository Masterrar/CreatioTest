namespace Terrasoft.Configuration
{
	...
	public class VwCommandActionSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwCommandAction_NUIEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwCommandAction_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwCommandAction
	{
