namespace Terrasoft.Configuration
{
	...
	public class EntitySchemaRecRightOperationSchema : Terrasoft.Configuration.BaseValueLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new EntitySchemaRecRightOperation_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class EntitySchemaRecRightOperation_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseValueLookup_BaseEventsProcess<TEntity> where TEntity : EntitySchemaRecRightOperation
	{
