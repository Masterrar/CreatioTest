namespace Terrasoft.Configuration
{
	...
	public class SysEntitySchemaParentAsscTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysEntitySchemaParentAsscType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysEntitySchemaParentAsscType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysEntitySchemaParentAsscType
	{
