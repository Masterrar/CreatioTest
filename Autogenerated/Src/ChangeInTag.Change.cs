namespace Terrasoft.Configuration
{
	...
	public class ChangeInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateChangeInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateChangeInTagEventsProcessSchema() {
			var schema = new ChangeInTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ChangeInTag_ChangeEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ChangeInTag_ChangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ChangeInTag
	{
	...
	#region Class: ChangeInTagEventsProcessSchema

	/// <exclude/>
	public class ChangeInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public ChangeInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ChangeInTagEventsProcessSchema(ChangeInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ChangeInTag_ChangeEventsProcess";
			UId = new Guid("cd4d1ede-82b7-4591-82d4-4665fc6bfce8");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ChangeInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("cd4d1ede-82b7-4591-82d4-4665fc6bfce8"));
		}
