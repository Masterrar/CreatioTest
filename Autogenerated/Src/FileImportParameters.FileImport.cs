namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class FileImportParameters_FileImportEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : FileImportParameters
	{
