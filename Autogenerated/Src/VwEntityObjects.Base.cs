namespace Terrasoft.Configuration
{
	...
	public class VwEntityObjectsSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwEntityObjects_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwEntityObjects_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwEntityObjects
	{
