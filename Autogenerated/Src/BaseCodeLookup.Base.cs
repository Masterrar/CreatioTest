namespace Terrasoft.Configuration
{
	...
	public class BaseCodeLookupSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BaseCodeLookup_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BaseCodeLookup_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BaseCodeLookup
	{
