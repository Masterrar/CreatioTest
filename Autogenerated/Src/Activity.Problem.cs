namespace Terrasoft.Configuration
{
	...
	public class Activity_Problem_TerrasoftSchema : Terrasoft.Configuration.Activity_Project_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateActivity_Problem_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateActivity_Problem_TerrasoftEventsProcessSchema() {
			var schema = new Activity_Problem_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Activity_ProblemEventsProcess(userConnnection);
		}
	...
	public class Activity_Problem_Terrasoft : Terrasoft.Configuration.Activity_Project_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Updated += (s, e) => ThrowEvent("Activity_Problem_TerrasoftUpdated", e);
			Updating += (s, e) => ThrowEvent("Activity_Problem_TerrasoftUpdating", e);
	...
	/// <exclude/>
	public class Activity_ProblemEventsProcess<TEntity> : Terrasoft.Configuration.Activity_ProjectEventsProcess<TEntity> where TEntity : Activity_Problem_Terrasoft
	{
	...
	#region Class: Activity_Problem_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class Activity_Problem_TerrasoftEventsProcessSchema : Terrasoft.Configuration.Activity_Project_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public Activity_Problem_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public Activity_Problem_TerrasoftEventsProcessSchema(Activity_Problem_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Activity_ProblemEventsProcess";
			UId = new Guid("4b1ec56d-c726-428c-9282-48075c275922");
			CreatedInPackageId = new Guid("7d431f1d-e167-4639-9031-b6a87693b6dc");
		...
		public override object Clone() {
			return new Activity_Problem_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("4b1ec56d-c726-428c-9282-48075c275922"));
		}
