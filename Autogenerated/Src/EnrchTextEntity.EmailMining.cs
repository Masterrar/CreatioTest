namespace Terrasoft.Configuration
{
	...
	public class EnrchTextEntitySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new EnrchTextEntity_EmailMiningEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class EnrchTextEntity_EmailMiningEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : EnrchTextEntity
	{
