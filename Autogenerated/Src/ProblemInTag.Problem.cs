namespace Terrasoft.Configuration
{
	...
	public class ProblemInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProblemInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProblemInTagEventsProcessSchema() {
			var schema = new ProblemInTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProblemInTag_ProblemEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProblemInTag_ProblemEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ProblemInTag
	{
	...
	#region Class: ProblemInTagEventsProcessSchema

	/// <exclude/>
	public class ProblemInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public ProblemInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProblemInTagEventsProcessSchema(ProblemInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProblemInTag_ProblemEventsProcess";
			UId = new Guid("46477933-42b5-4eb4-aec1-ac55fccaa776");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ProblemInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("46477933-42b5-4eb4-aec1-ac55fccaa776"));
		}
