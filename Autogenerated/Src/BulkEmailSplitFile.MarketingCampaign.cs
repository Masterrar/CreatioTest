namespace Terrasoft.Configuration
{
	...
	public class BulkEmailSplitFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBulkEmailSplitFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBulkEmailSplitFileEventsProcessSchema() {
			var schema = new BulkEmailSplitFileEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BulkEmailSplitFile_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BulkEmailSplitFile_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : BulkEmailSplitFile
	{
	...
	#region Class: BulkEmailSplitFileEventsProcessSchema

	/// <exclude/>
	public class BulkEmailSplitFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public BulkEmailSplitFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BulkEmailSplitFileEventsProcessSchema(BulkEmailSplitFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BulkEmailSplitFile_MarketingCampaignEventsProcess";
			UId = new Guid("7af37109-e236-44dd-b404-16f40d6f46ff");
			CreatedInPackageId = new Guid("8a6b5719-da97-4634-8f04-4375bc29ffcf");
		...
		public override object Clone() {
			return new BulkEmailSplitFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("7af37109-e236-44dd-b404-16f40d6f46ff"));
		}
