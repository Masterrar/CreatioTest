namespace Terrasoft.Configuration
{
	...
	public class ProblemTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProblemTagEventsProcessSchema();
		}
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProblemTag_ProblemEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProblemTag_ProblemEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ProblemTag
	{
	...
	#region Class: ProblemTagEventsProcessSchema

	/// <exclude/>
	public class ProblemTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public ProblemTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProblemTag_ProblemEventsProcess";
			UId = new Guid("36990129-a6c0-41ba-ac78-f450027c96e1");
			CreatedInPackageId = new Guid("dfe2c6b5-61e8-4e57-95ae-a3c34fa0908f");
		...
		public override object Clone() {
			return new ProblemTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("36990129-a6c0-41ba-ac78-f450027c96e1"));
		}
