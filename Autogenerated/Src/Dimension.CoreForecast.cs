namespace Terrasoft.Configuration
{
	...
	public class DimensionSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Dimension_CoreForecastEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Dimension_CoreForecastEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Dimension
	{
