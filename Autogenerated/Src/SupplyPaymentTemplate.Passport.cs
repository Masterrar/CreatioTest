namespace Terrasoft.Configuration
{
	...
	public class SupplyPaymentTemplateSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SupplyPaymentTemplate_PassportEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SupplyPaymentTemplate_PassportEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SupplyPaymentTemplate
	{
