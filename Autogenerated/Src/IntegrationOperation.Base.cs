namespace Terrasoft.Configuration
{
	...
	public class IntegrationOperationSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new IntegrationOperation_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class IntegrationOperation_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : IntegrationOperation
	{
