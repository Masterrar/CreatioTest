namespace Terrasoft.Configuration
{
	...
	public class BulkEmailSubsStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBulkEmailSubsStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBulkEmailSubsStatusEventsProcessSchema() {
			var schema = new BulkEmailSubsStatusEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BulkEmailSubsStatus_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BulkEmailSubsStatus_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : BulkEmailSubsStatus
	{
	...
	#region Class: BulkEmailSubsStatusEventsProcessSchema

	/// <exclude/>
	public class BulkEmailSubsStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public BulkEmailSubsStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BulkEmailSubsStatusEventsProcessSchema(BulkEmailSubsStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BulkEmailSubsStatus_MarketingCampaignEventsProcess";
			UId = new Guid("396e6204-3bf8-4040-9f06-cad4be8ae935");
			CreatedInPackageId = new Guid("036273dd-d44c-45e1-8c98-d51acfaf8b95");
		...
		public override object Clone() {
			return new BulkEmailSubsStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("396e6204-3bf8-4040-9f06-cad4be8ae935"));
		}
