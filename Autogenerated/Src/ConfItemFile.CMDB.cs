namespace Terrasoft.Configuration
{
	...
	public class ConfItemFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateConfItemFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateConfItemFileEventsProcessSchema() {
			var schema = new ConfItemFileEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ConfItemFile_CMDBEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ConfItemFile_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ConfItemFile
	{
	...
	#region Class: ConfItemFileEventsProcessSchema

	/// <exclude/>
	public class ConfItemFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public ConfItemFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ConfItemFileEventsProcessSchema(ConfItemFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ConfItemFile_CMDBEventsProcess";
			UId = new Guid("3675601b-c974-4202-bbf7-8e3bc0198d80");
			CreatedInPackageId = new Guid("305fcfca-4160-4398-90a9-d5e84be0ae12");
		...
		public override object Clone() {
			return new ConfItemFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("3675601b-c974-4202-bbf7-8e3bc0198d80"));
		}
