namespace Terrasoft.Configuration
{
	...
	public class PartnershipParamTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePartnershipParamTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePartnershipParamTypeEventsProcessSchema() {
			var schema = new PartnershipParamTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: PartnershipParamTypeEventsProcessSchema

	/// <exclude/>
	public class PartnershipParamTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public PartnershipParamTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PartnershipParamTypeEventsProcessSchema(PartnershipParamTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "PartnershipParamType_PRMBaseEventsProcess";
			UId = new Guid("62dba83f-bbfd-4eb0-af6a-eb2b733bb08c");
			CreatedInPackageId = new Guid("867b9a25-86bf-4a3e-8ecd-b6e40f57be82");
		...
		public override object Clone() {
			return new PartnershipParamTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("62dba83f-bbfd-4eb0-af6a-eb2b733bb08c"));
		}
