namespace Terrasoft.Configuration
{
	...
	public class ProjectEntryTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProjectEntryType_ProjectEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProjectEntryType_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : ProjectEntryType
	{
