namespace Terrasoft.Configuration
{
	...
	public class OpportunityFolderSchema : Terrasoft.Configuration.OpportunityFolder_Opportunity_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOpportunityFolderEventsProcessSchema() {
			var schema = new OpportunityFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OpportunityFolderEventsProcessSchema

	/// <exclude/>
	public class OpportunityFolderEventsProcessSchema : Terrasoft.Configuration.OpportunityFolder_Opportunity_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OpportunityFolderEventsProcessSchema(OpportunityFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityFolder_PRMPortalEventsProcess";
			UId = new Guid("0d2f96f4-9668-4c2a-831c-6153cbb977a0");
			CreatedInPackageId = new Guid("580620fc-064a-4cdc-95d9-80175a4d3b0d");
			...
			ParentSchemaUId = new Guid("f934feb5-ad35-4c9d-bd64-0e8b19f9f631");
		...
		public override object Clone() {
			return new OpportunityFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0d2f96f4-9668-4c2a-831c-6153cbb977a0"));
		}
