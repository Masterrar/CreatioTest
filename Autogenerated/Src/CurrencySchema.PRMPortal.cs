namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CurrencySchema : Terrasoft.Configuration.Currency_UIv2_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCurrencyEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCurrencyEventsProcessSchema() {
			var schema = new CurrencyEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// Currency.
	/// </summary>
	public class Currency : Terrasoft.Configuration.Currency_UIv2_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Currency_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.Currency_UIv2EventsProcess<TEntity> where TEntity : Currency
	{
	...
	/// <exclude/>
	public class Currency_PRMPortalEventsProcess : Currency_PRMPortalEventsProcess<Currency>
	{
	...
	#region Class: CurrencyEventsProcessSchema

	/// <exclude/>
	public class CurrencyEventsProcessSchema : Terrasoft.Configuration.Currency_UIv2_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public CurrencyEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CurrencyEventsProcessSchema(CurrencyEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Currency_PRMPortalEventsProcess";
			UId = new Guid("01688f26-91f9-4e8c-bf35-9e5166e9db73");
			CreatedInPackageId = new Guid("667fe825-207f-46da-8fb7-a082f81fd079");
			...
			ParentSchemaUId = new Guid("fe9d77df-4e59-4950-b89b-0eae5182a9a9");
		...
		public override object Clone() {
			return new CurrencyEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("01688f26-91f9-4e8c-bf35-9e5166e9db73"));
		}
	...
	/// <exclude/>
	public class CurrencyEventsProcess : Currency_PRMPortalEventsProcess
	{
