namespace Terrasoft.Configuration
{
	...
	public class SysMobileWorkplaceSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysMobileWorkplace_MobileEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysMobileWorkplace_MobileEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysMobileWorkplace
	{
