namespace Terrasoft.Configuration
{
	...
	public class VwClientAddressSchema : Terrasoft.Configuration.VwClientAddress_Order_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwClientAddressEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwClientAddressEventsProcessSchema() {
			var schema = new VwClientAddressEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwClientAddressEventsProcessSchema

	/// <exclude/>
	public class VwClientAddressEventsProcessSchema : Terrasoft.Configuration.VwClientAddress_Order_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public VwClientAddressEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwClientAddressEventsProcessSchema(VwClientAddressEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwClientAddress_PRMOrderEventsProcess";
			UId = new Guid("fc1b7662-16e1-4101-bb6e-ed5942ee7754");
			CreatedInPackageId = new Guid("d6ad04c1-fa0b-4adb-bfd8-17ec17775a03");
		...
		public override object Clone() {
			return new VwClientAddressEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("fc1b7662-16e1-4101-bb6e-ed5942ee7754"));
		}
