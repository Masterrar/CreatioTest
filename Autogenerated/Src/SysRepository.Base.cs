namespace Terrasoft.Configuration
{
	...
	public class SysRepositorySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysRepository_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysRepository_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysRepository
	{
