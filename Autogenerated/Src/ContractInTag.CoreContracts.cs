namespace Terrasoft.Configuration
{
	...
	public class ContractInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ContractInTag_CoreContractsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ContractInTag_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ContractInTag
	{
