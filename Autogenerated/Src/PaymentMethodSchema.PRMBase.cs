namespace Terrasoft.Configuration
{
	...
	public class PaymentMethodSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePaymentMethodEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePaymentMethodEventsProcessSchema() {
			var schema = new PaymentMethodEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: PaymentMethodEventsProcessSchema

	/// <exclude/>
	public class PaymentMethodEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public PaymentMethodEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PaymentMethodEventsProcessSchema(PaymentMethodEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "PaymentMethod_PRMBaseEventsProcess";
			UId = new Guid("50ca54ff-ee8f-4c15-b154-204e1dd8b6f5");
			CreatedInPackageId = new Guid("867b9a25-86bf-4a3e-8ecd-b6e40f57be82");
		...
		public override object Clone() {
			return new PaymentMethodEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("50ca54ff-ee8f-4c15-b154-204e1dd8b6f5"));
		}
