namespace Terrasoft.Configuration
{
	...
	public class SysPrcHistoryLogSchema : Terrasoft.Configuration.SysProcessLogSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysPrcHistoryLog_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysPrcHistoryLog_BaseEventsProcess<TEntity> : Terrasoft.Configuration.SysProcessLog_PRMPortalEventsProcess<TEntity> where TEntity : SysPrcHistoryLog
	{
