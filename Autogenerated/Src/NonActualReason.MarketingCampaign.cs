namespace Terrasoft.Configuration
{
	...
	public class NonActualReasonSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateNonActualReasonEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateNonActualReasonEventsProcessSchema() {
			var schema = new NonActualReasonEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new NonActualReason_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class NonActualReason_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : NonActualReason
	{
	...
	#region Class: NonActualReasonEventsProcessSchema

	/// <exclude/>
	public class NonActualReasonEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public NonActualReasonEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public NonActualReasonEventsProcessSchema(NonActualReasonEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "NonActualReason_MarketingCampaignEventsProcess";
			UId = new Guid("c4a1431a-3eb9-4c62-a889-8366f6fe1f34");
			CreatedInPackageId = new Guid("23e6b872-7cf2-4336-8046-3b06c9b28cbc");
		...
		public override object Clone() {
			return new NonActualReasonEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c4a1431a-3eb9-4c62-a889-8366f6fe1f34"));
		}
