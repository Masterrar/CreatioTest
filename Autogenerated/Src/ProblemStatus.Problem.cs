namespace Terrasoft.Configuration
{
	...
	public class ProblemStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProblemStatusEventsProcessSchema();
		}
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProblemStatus_ProblemEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProblemStatus_ProblemEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ProblemStatus
	{
	...
	#region Class: ProblemStatusEventsProcessSchema

	/// <exclude/>
	public class ProblemStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ProblemStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProblemStatus_ProblemEventsProcess";
			UId = new Guid("a6b9f09d-434f-47fd-85fb-e0939879e6e1");
			CreatedInPackageId = new Guid("305fcfca-4160-4398-90a9-d5e84be0ae12");
		...
		public override object Clone() {
			return new ProblemStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a6b9f09d-434f-47fd-85fb-e0939879e6e1"));
		}
