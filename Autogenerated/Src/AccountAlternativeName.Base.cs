namespace Terrasoft.Configuration
{
	...
	public class AccountAlternativeNameSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new AccountAlternativeName_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class AccountAlternativeName_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : AccountAlternativeName
	{
