namespace Terrasoft.Configuration
{
	...
	public class AutoProcessingLogSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAutoProcessingLogEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateAutoProcessingLogEventsProcessSchema() {
			var schema = new AutoProcessingLogEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new AutoProcessingLog_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class AutoProcessingLog_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : AutoProcessingLog
	{
	...
	#region Class: AutoProcessingLogEventsProcessSchema

	/// <exclude/>
	public class AutoProcessingLogEventsProcessSchema : Terrasoft.Core.Process.EmbeddedProcessSchema
	{

		#region Constructors: Public

		public AutoProcessingLogEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public AutoProcessingLogEventsProcessSchema(AutoProcessingLogEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "AutoProcessingLog_MarketingCampaignEventsProcess";
			UId = new Guid("8d52744b-6010-4058-b219-8c9e4933bd02");
			CreatedInPackageId = new Guid("ad2d5243-f3e1-4196-99cf-d5d7d1dcc487");
		...
		public override object Clone() {
			return new AutoProcessingLogEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("8d52744b-6010-4058-b219-8c9e4933bd02"));
		}
