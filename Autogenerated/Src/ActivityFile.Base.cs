namespace Terrasoft.Configuration
{
	...
	public class ActivityFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ActivityFile_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ActivityFile_BaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ActivityFile
	{
