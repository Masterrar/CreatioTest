namespace Terrasoft.Configuration
{
	...
	public class ProductSchema : Terrasoft.Configuration.Product_ProductCatalogue_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProductEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProductEventsProcessSchema() {
			var schema = new ProductEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ProductEventsProcessSchema

	/// <exclude/>
	public class ProductEventsProcessSchema : Terrasoft.Configuration.Product_ProductCatalogue_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public ProductEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProductEventsProcessSchema(ProductEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Product_PRMPortalEventsProcess";
			UId = new Guid("f7edee97-596d-49f8-afcd-5dd62ec96775");
			CreatedInPackageId = new Guid("10676561-1f93-46bf-90be-fe5cd67025e0");
		...
		public override object Clone() {
			return new ProductEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f7edee97-596d-49f8-afcd-5dd62ec96775"));
		}
