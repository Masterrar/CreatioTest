namespace Terrasoft.Configuration
{
	...
	public class CampaignScheduledModeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignScheduledModeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignScheduledModeEventsProcessSchema() {
			var schema = new CampaignScheduledModeEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignScheduledMode_CampaignsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignScheduledMode_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignScheduledMode
	{
	...
	#region Class: CampaignScheduledModeEventsProcessSchema

	/// <exclude/>
	public class CampaignScheduledModeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignScheduledModeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignScheduledModeEventsProcessSchema(CampaignScheduledModeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignScheduledMode_CampaignsEventsProcess";
			UId = new Guid("a62e6666-2463-4a89-bb43-64f1254806bb");
			CreatedInPackageId = new Guid("6c038aa0-46cd-4697-bc93-5c682e364aef");
		...
		public override object Clone() {
			return new CampaignScheduledModeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a62e6666-2463-4a89-bb43-64f1254806bb"));
		}
