namespace Terrasoft.Configuration
{
	...
	public class ProductInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProductInFolder_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProductInFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ProductInFolder
	{
