namespace Terrasoft.Configuration
{
	...
	public class EventFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEventFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEventFolderEventsProcessSchema() {
			var schema = new EventFolderEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new EventFolder_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class EventFolder_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : EventFolder
	{
	...
	#region Class: EventFolderEventsProcessSchema

	/// <exclude/>
	public class EventFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public EventFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EventFolderEventsProcessSchema(EventFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EventFolder_MarketingCampaignEventsProcess";
			UId = new Guid("25c87c13-1fa3-4696-97e3-4d8346d39162");
			CreatedInPackageId = new Guid("b827f319-d8b8-41a8-9645-da32137f000d");
		...
		public override object Clone() {
			return new EventFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("25c87c13-1fa3-4696-97e3-4d8346d39162"));
		}
