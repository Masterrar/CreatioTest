namespace Terrasoft.Configuration
{
	...
	public class OpportunityCreateReasonSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new OpportunityCreateReason_OpportunityEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class OpportunityCreateReason_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : OpportunityCreateReason
	{
