namespace Terrasoft.Configuration
{
	...
	public class SiteEventTypeTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSiteEventTypeTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSiteEventTypeTagEventsProcessSchema() {
			var schema = new SiteEventTypeTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SiteEventTypeTag_EventTrackingEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SiteEventTypeTag_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : SiteEventTypeTag
	{
	...
	#region Class: SiteEventTypeTagEventsProcessSchema

	/// <exclude/>
	public class SiteEventTypeTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public SiteEventTypeTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SiteEventTypeTagEventsProcessSchema(SiteEventTypeTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SiteEventTypeTag_EventTrackingEventsProcess";
			UId = new Guid("eb0022f9-572e-46c7-b127-f318fc5442e0");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new SiteEventTypeTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("eb0022f9-572e-46c7-b127-f318fc5442e0"));
		}
