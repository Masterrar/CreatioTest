namespace Terrasoft.Configuration
{
	...
	public class CampaignTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignTypeEventsProcessSchema() {
			var schema = new CampaignTypeEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignType_CampaignsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignType_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignType
	{
	...
	#region Class: CampaignTypeEventsProcessSchema

	/// <exclude/>
	public class CampaignTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignTypeEventsProcessSchema(CampaignTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignType_CampaignsEventsProcess";
			UId = new Guid("b823b102-b082-4d9a-a14f-1be230bfb1cb");
			CreatedInPackageId = new Guid("0fa99f9a-3eca-422f-9a3c-3294c39b5190");
		...
		public override object Clone() {
			return new CampaignTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b823b102-b082-4d9a-a14f-1be230bfb1cb"));
		}
