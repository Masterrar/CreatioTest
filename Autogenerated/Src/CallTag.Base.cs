namespace Terrasoft.Configuration
{
	...
	public class CallTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CallTag_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CallTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : CallTag
	{
