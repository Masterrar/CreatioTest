namespace Terrasoft.Configuration
{
	...
	public class LeadInFolderSchema : Terrasoft.Configuration.LeadInFolder_Lead_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLeadInFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLeadInFolderEventsProcessSchema() {
			var schema = new LeadInFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: LeadInFolderEventsProcessSchema

	/// <exclude/>
	public class LeadInFolderEventsProcessSchema : Terrasoft.Configuration.LeadInFolder_Lead_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public LeadInFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LeadInFolderEventsProcessSchema(LeadInFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LeadInFolder_PRMPortalEventsProcess";
			UId = new Guid("a344b568-a5ac-4c83-8149-9056703a8c4b");
			CreatedInPackageId = new Guid("0fffc5a3-cd85-4e12-bfdb-f47322f14e3d");
			...
			ParentSchemaUId = new Guid("8154db0f-e858-4fe1-87f7-3cfb57c7506a");
		...
		public override object Clone() {
			return new LeadInFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a344b568-a5ac-4c83-8149-9056703a8c4b"));
		}
