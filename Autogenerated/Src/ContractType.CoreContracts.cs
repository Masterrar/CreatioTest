namespace Terrasoft.Configuration
{
	...
	public class ContractType_CoreContracts_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ContractType_CoreContractsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ContractType_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ContractType_CoreContracts_Terrasoft
	{
