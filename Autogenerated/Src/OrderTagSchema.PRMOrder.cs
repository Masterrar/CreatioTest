namespace Terrasoft.Configuration
{
	...
	public class OrderTagSchema : Terrasoft.Configuration.OrderTag_Order_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOrderTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOrderTagEventsProcessSchema() {
			var schema = new OrderTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OrderTagEventsProcessSchema

	/// <exclude/>
	public class OrderTagEventsProcessSchema : Terrasoft.Configuration.OrderTag_Order_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OrderTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OrderTagEventsProcessSchema(OrderTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OrderTag_PRMOrderEventsProcess";
			UId = new Guid("9b030e0c-48a9-4d55-bfb8-25da1c35cb0a");
			CreatedInPackageId = new Guid("c09bcc89-cd4a-49df-a8fa-3a15879bc3c5");
			...
			ParentSchemaUId = new Guid("57cb6402-a775-4f20-851f-7133c5d2d64d");
		...
		public override object Clone() {
			return new OrderTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9b030e0c-48a9-4d55-bfb8-25da1c35cb0a"));
		}
