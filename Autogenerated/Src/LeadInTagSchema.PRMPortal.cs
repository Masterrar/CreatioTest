namespace Terrasoft.Configuration
{
	...
	public class LeadInTagSchema : Terrasoft.Configuration.LeadInTag_Lead_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLeadInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLeadInTagEventsProcessSchema() {
			var schema = new LeadInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: LeadInTagEventsProcessSchema

	/// <exclude/>
	public class LeadInTagEventsProcessSchema : Terrasoft.Configuration.LeadInTag_Lead_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public LeadInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LeadInTagEventsProcessSchema(LeadInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LeadInTag_PRMPortalEventsProcess";
			UId = new Guid("633ab361-b2c0-4e6b-a696-caadcd68df65");
			CreatedInPackageId = new Guid("0fffc5a3-cd85-4e12-bfdb-f47322f14e3d");
			...
			ParentSchemaUId = new Guid("f35df262-615d-4ecf-8df3-0ff619549e21");
		...
		public override object Clone() {
			return new LeadInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("633ab361-b2c0-4e6b-a696-caadcd68df65"));
		}
