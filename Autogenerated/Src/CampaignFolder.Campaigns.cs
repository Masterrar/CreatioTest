namespace Terrasoft.Configuration
{
	...
	public class CampaignFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignFolderEventsProcessSchema() {
			var schema = new CampaignFolderEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignFolder_CampaignsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignFolder_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : CampaignFolder
	{
	...
	#region Class: CampaignFolderEventsProcessSchema

	/// <exclude/>
	public class CampaignFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignFolderEventsProcessSchema(CampaignFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignFolder_CampaignsEventsProcess";
			UId = new Guid("b6c1dbc2-7a72-4722-ab7f-89578b460cff");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new CampaignFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b6c1dbc2-7a72-4722-ab7f-89578b460cff"));
		}
