namespace Terrasoft.Configuration
{
	...
	public class SysDcmSchemaInSettingsSchema : Terrasoft.Configuration.SysDcmSchemaInSettings_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysDcmSchemaInSettingsEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysDcmSchemaInSettingsEventsProcessSchema() {
			var schema = new SysDcmSchemaInSettingsEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysDcmSchemaInSettingsEventsProcessSchema

	/// <exclude/>
	public class SysDcmSchemaInSettingsEventsProcessSchema : Terrasoft.Configuration.SysDcmSchemaInSettings_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public SysDcmSchemaInSettingsEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysDcmSchemaInSettingsEventsProcessSchema(SysDcmSchemaInSettingsEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysDcmSchemaInSettings_PRMPortalEventsProcess";
			UId = new Guid("b4b944ed-86b1-4217-b6f5-af3c5d6775a3");
			CreatedInPackageId = new Guid("2b000645-6072-461d-8963-11edfee86881");
			...
			ParentSchemaUId = new Guid("df9ae527-8e6e-4d7c-8f3c-c4ed67b2c202");
		...
		public override object Clone() {
			return new SysDcmSchemaInSettingsEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b4b944ed-86b1-4217-b6f5-af3c5d6775a3"));
		}
