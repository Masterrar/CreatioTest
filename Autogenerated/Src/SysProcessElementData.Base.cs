namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SysProcessElementData_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysProcessElementData
	{
