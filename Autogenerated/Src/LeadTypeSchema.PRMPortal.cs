namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class LeadTypeSchema : Terrasoft.Configuration.LeadType_Lead_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLeadTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLeadTypeEventsProcessSchema() {
			var schema = new LeadTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// Lead type.
	/// </summary>
	public class LeadType : Terrasoft.Configuration.LeadType_Lead_Terrasoft
	{
	...
	/// <exclude/>
	public partial class LeadType_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.LeadType_LeadEventsProcess<TEntity> where TEntity : LeadType
	{
	...
	#region Class: LeadTypeEventsProcessSchema

	/// <exclude/>
	public class LeadTypeEventsProcessSchema : Terrasoft.Configuration.LeadType_Lead_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public LeadTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LeadTypeEventsProcessSchema(LeadTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LeadType_PRMPortalEventsProcess";
			UId = new Guid("a5fd1f75-1d7c-4712-9443-d4dc5c23d063");
			CreatedInPackageId = new Guid("10676561-1f93-46bf-90be-fe5cd67025e0");
			...
			ParentSchemaUId = new Guid("3ced1c56-aff9-4070-9a57-1090250c4155");
		...
		public override object Clone() {
			return new LeadTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a5fd1f75-1d7c-4712-9443-d4dc5c23d063"));
		}
