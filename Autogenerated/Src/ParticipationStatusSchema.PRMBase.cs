namespace Terrasoft.Configuration
{
	...
	public class ParticipationStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateParticipationStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateParticipationStatusEventsProcessSchema() {
			var schema = new ParticipationStatusEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ParticipationStatusEventsProcessSchema

	/// <exclude/>
	public class ParticipationStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ParticipationStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ParticipationStatusEventsProcessSchema(ParticipationStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ParticipationStatus_PRMBaseEventsProcess";
			UId = new Guid("80c5fbc2-7073-4188-8df2-9e2d414182ba");
			CreatedInPackageId = new Guid("867b9a25-86bf-4a3e-8ecd-b6e40f57be82");
		...
		public override object Clone() {
			return new ParticipationStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("80c5fbc2-7073-4188-8df2-9e2d414182ba"));
		}
