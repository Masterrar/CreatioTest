namespace Terrasoft.Configuration
{
	...
	public class PartnerTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePartnerTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePartnerTypeEventsProcessSchema() {
			var schema = new PartnerTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: PartnerTypeEventsProcessSchema

	/// <exclude/>
	public class PartnerTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public PartnerTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PartnerTypeEventsProcessSchema(PartnerTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "PartnerType_PRMBaseEventsProcess";
			UId = new Guid("d6b3ea00-ea3a-42f0-b505-40366400df5f");
			CreatedInPackageId = new Guid("867b9a25-86bf-4a3e-8ecd-b6e40f57be82");
		...
		public override object Clone() {
			return new PartnerTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("d6b3ea00-ea3a-42f0-b505-40366400df5f"));
		}
