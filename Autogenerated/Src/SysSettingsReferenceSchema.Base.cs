namespace Terrasoft.Configuration
{
	...
	public class SysSettingsReferenceSchemaSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysSettingsReferenceSchema_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysSettingsReferenceSchema_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysSettingsReferenceSchema
	{
