namespace Terrasoft.Configuration
{
	...
	public class SysModuleFolderModeSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysModuleFolderMode_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysModuleFolderMode_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleFolderMode
	{
