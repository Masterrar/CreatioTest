namespace Terrasoft.Configuration
{
	...
	public class ReasonForLeavingSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ReasonForLeaving_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ReasonForLeaving_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ReasonForLeaving
	{
