namespace Terrasoft.Configuration
{
	...
	public class VwSysPackagesSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwSysPackages_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwSysPackages_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwSysPackages
	{
