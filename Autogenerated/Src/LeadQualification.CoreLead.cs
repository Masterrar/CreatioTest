namespace Terrasoft.Configuration
{
	...
	public class LeadQualificationSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new LeadQualification_CoreLeadEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class LeadQualification_CoreLeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : LeadQualification
	{
