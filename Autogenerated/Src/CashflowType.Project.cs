namespace Terrasoft.Configuration
{
	...
	public class CashflowTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CashflowType_ProjectEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CashflowType_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CashflowType
	{
