namespace Terrasoft.Configuration
{
	...
	public class ContactInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ContactInTag_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ContactInTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ContactInTag
	{
