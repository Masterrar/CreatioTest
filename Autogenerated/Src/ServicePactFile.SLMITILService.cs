namespace Terrasoft.Configuration
{
	...
	public class ServicePactFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateServicePactFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateServicePactFileEventsProcessSchema() {
			var schema = new ServicePactFileEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ServicePactFile_SLMITILServiceEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ServicePactFile_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ServicePactFile
	{
	...
	#region Class: ServicePactFileEventsProcessSchema

	/// <exclude/>
	public class ServicePactFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public ServicePactFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ServicePactFileEventsProcessSchema(ServicePactFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ServicePactFile_SLMITILServiceEventsProcess";
			UId = new Guid("ff5f4ad7-03a9-450b-b89d-75f8bade3fb5");
			CreatedInPackageId = new Guid("ffa69c6a-c8bb-4a61-bc00-b0bcd40a9862");
		...
		public override object Clone() {
			return new ServicePactFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("ff5f4ad7-03a9-450b-b89d-75f8bade3fb5"));
		}
