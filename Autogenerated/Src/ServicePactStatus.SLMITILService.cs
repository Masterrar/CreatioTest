namespace Terrasoft.Configuration
{
	...
	public class ServicePactStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateServicePactStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateServicePactStatusEventsProcessSchema() {
			var schema = new ServicePactStatusEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ServicePactStatus_SLMITILServiceEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ServicePactStatus_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ServicePactStatus
	{
	...
	#region Class: ServicePactStatusEventsProcessSchema

	/// <exclude/>
	public class ServicePactStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ServicePactStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ServicePactStatusEventsProcessSchema(ServicePactStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ServicePactStatus_SLMITILServiceEventsProcess";
			UId = new Guid("b9e2e73f-92ec-42ec-b3a2-85ba30e3645f");
			CreatedInPackageId = new Guid("ffa69c6a-c8bb-4a61-bc00-b0bcd40a9862");
		...
		public override object Clone() {
			return new ServicePactStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b9e2e73f-92ec-42ec-b3a2-85ba30e3645f"));
		}
