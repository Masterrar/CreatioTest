namespace Terrasoft.Configuration
{
	...
	public class ConfItemInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateConfItemInFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateConfItemInFolderEventsProcessSchema() {
			var schema = new ConfItemInFolderEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ConfItemInFolder_CMDBEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ConfItemInFolder_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ConfItemInFolder
	{
	...
	#region Class: ConfItemInFolderEventsProcessSchema

	/// <exclude/>
	public class ConfItemInFolderEventsProcessSchema : Terrasoft.Configuration.BaseItemInFolderEventsProcessSchema
	{

		#region Constructors: Public

		public ConfItemInFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ConfItemInFolderEventsProcessSchema(ConfItemInFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ConfItemInFolder_CMDBEventsProcess";
			UId = new Guid("11171ab1-7840-4bc8-84ca-70066889fb80");
			CreatedInPackageId = new Guid("305fcfca-4160-4398-90a9-d5e84be0ae12");
		...
		public override object Clone() {
			return new ConfItemInFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("11171ab1-7840-4bc8-84ca-70066889fb80"));
		}
