namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OppDepartmentForecast_CoreForecastEventsProcess<TEntity> : Terrasoft.Configuration.EntityInForecastCell_CoreForecastEventsProcess<TEntity> where TEntity : OppDepartmentForecast
	{
