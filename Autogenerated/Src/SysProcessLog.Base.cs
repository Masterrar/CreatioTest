namespace Terrasoft.Configuration
{
	...
	public class SysProcessLog_Base_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysProcessLog_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysProcessLog_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysProcessLog_Base_Terrasoft
	{
