namespace Terrasoft.Configuration
{
	...
	public class SysAdminUnitFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysAdminUnitFolder_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysAdminUnitFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : SysAdminUnitFolder
	{
