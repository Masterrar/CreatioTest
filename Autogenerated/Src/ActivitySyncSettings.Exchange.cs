namespace Terrasoft.Configuration
{
	...
	public class ActivitySyncSettingsSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ActivitySyncSettings_ExchangeEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ActivitySyncSettings_ExchangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ActivitySyncSettings
	{
