namespace Terrasoft.Configuration
{
	...
	public class GeneratedWebFormSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new GeneratedWebForm_WebFormEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class GeneratedWebForm_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : GeneratedWebForm
	{
