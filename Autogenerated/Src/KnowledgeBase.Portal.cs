namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBase_Portal_TerrasoftSchema : Terrasoft.Configuration.KnowledgeBase_SspKnowledgeBase_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateKnowledgeBase_Portal_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateKnowledgeBase_Portal_TerrasoftEventsProcessSchema() {
			var schema = new KnowledgeBase_Portal_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new KnowledgeBase_PortalEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class KnowledgeBase_PortalEventsProcess<TEntity> : Terrasoft.Configuration.KnowledgeBase_SspKnowledgeBaseEventsProcess<TEntity> where TEntity : KnowledgeBase_Portal_Terrasoft
	{
	...
	#region Class: KnowledgeBase_Portal_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class KnowledgeBase_Portal_TerrasoftEventsProcessSchema : Terrasoft.Configuration.KnowledgeBase_SspKnowledgeBase_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public KnowledgeBase_Portal_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public KnowledgeBase_Portal_TerrasoftEventsProcessSchema(KnowledgeBase_Portal_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "KnowledgeBase_PortalEventsProcess";
			UId = new Guid("794d0118-11cc-4120-a5a5-323f0e44cd0c");
			CreatedInPackageId = new Guid("929a7200-398f-4e6f-a56d-d74f21f8bfe0");
		...
		public override object Clone() {
			return new KnowledgeBase_Portal_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("794d0118-11cc-4120-a5a5-323f0e44cd0c"));
		}
