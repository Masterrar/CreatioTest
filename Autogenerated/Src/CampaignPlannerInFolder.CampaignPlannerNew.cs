namespace Terrasoft.Configuration
{
	...
	public class CampaignPlannerInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignPlannerInFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignPlannerInFolderEventsProcessSchema() {
			var schema = new CampaignPlannerInFolderEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignPlannerInFolder_CampaignPlannerNewEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignPlannerInFolder_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : CampaignPlannerInFolder
	{
	...
	#region Class: CampaignPlannerInFolderEventsProcessSchema

	/// <exclude/>
	public class CampaignPlannerInFolderEventsProcessSchema : Terrasoft.Configuration.BaseItemInFolderEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignPlannerInFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignPlannerInFolderEventsProcessSchema(CampaignPlannerInFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignPlannerInFolder_CampaignPlannerNewEventsProcess";
			UId = new Guid("dad9ce6e-6486-47e9-9600-ee92987a0742");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new CampaignPlannerInFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("dad9ce6e-6486-47e9-9600-ee92987a0742"));
		}
