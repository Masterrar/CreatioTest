namespace Terrasoft.Configuration
{
	...
	public class ProductSourceSchema : Terrasoft.Configuration.BaseImageLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProductSource_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProductSource_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseImageLookup_BaseEventsProcess<TEntity> where TEntity : ProductSource
	{
