namespace Terrasoft.Configuration
{
	...
	public class VwSysProcessFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwSysProcessFolder_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwSysProcessFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : VwSysProcessFolder
	{
