namespace Terrasoft.Configuration
{
	...
	public class SspEntityRightsRegulator
	{
		...
		public void ManageEntityOrganizationRights(Guid entityId, Guid newPartnerId, Guid oldPartnerId) {
		...
		public void ManageEntityOwnerRights(Guid entityId, Guid ownerId, Guid oldOwnerId) {
