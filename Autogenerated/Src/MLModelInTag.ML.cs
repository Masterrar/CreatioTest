namespace Terrasoft.Configuration
{
	...
	public class MLModelInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new MLModelInTag_MLEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class MLModelInTag_MLEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : MLModelInTag
	{
