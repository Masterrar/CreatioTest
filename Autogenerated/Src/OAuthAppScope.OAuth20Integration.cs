namespace Terrasoft.Configuration
{
	...
	public class OAuthAppScopeSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new OAuthAppScope_OAuth20IntegrationEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class OAuthAppScope_OAuth20IntegrationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : OAuthAppScope
	{
