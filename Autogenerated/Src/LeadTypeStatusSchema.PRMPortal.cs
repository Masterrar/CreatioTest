namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class LeadTypeStatusSchema : Terrasoft.Configuration.LeadTypeStatus_Lead_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLeadTypeStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLeadTypeStatusEventsProcessSchema() {
			var schema = new LeadTypeStatusEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// Lead type status.
	/// </summary>
	public class LeadTypeStatus : Terrasoft.Configuration.LeadTypeStatus_Lead_Terrasoft
	{
	...
	/// <exclude/>
	public partial class LeadTypeStatus_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.LeadTypeStatus_LeadEventsProcess<TEntity> where TEntity : LeadTypeStatus
	{
	...
	#region Class: LeadTypeStatusEventsProcessSchema

	/// <exclude/>
	public class LeadTypeStatusEventsProcessSchema : Terrasoft.Configuration.LeadTypeStatus_Lead_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public LeadTypeStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LeadTypeStatusEventsProcessSchema(LeadTypeStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LeadTypeStatus_PRMPortalEventsProcess";
			UId = new Guid("cb83c78f-4e27-43f1-b0d4-b8b5ffdb90ee");
			CreatedInPackageId = new Guid("10676561-1f93-46bf-90be-fe5cd67025e0");
			...
			ParentSchemaUId = new Guid("dfca4018-26c5-43a4-a51c-6e53f1f70d4e");
		...
		public override object Clone() {
			return new LeadTypeStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("cb83c78f-4e27-43f1-b0d4-b8b5ffdb90ee"));
		}
