namespace Terrasoft.Configuration
{
	...
	public class EduActivityTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEduActivityTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEduActivityTypeEventsProcessSchema() {
			var schema = new EduActivityTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: EduActivityTypeEventsProcessSchema

	/// <exclude/>
	public class EduActivityTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public EduActivityTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EduActivityTypeEventsProcessSchema(EduActivityTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EduActivityType_PRMBaseEventsProcess";
			UId = new Guid("fc0bfda0-9de1-4a73-9b21-3010f07779f6");
			CreatedInPackageId = new Guid("867b9a25-86bf-4a3e-8ecd-b6e40f57be82");
		...
		public override object Clone() {
			return new EduActivityTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("fc0bfda0-9de1-4a73-9b21-3010f07779f6"));
		}
