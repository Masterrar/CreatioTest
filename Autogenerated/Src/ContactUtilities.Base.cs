	...
	public static class ContactUtilities
	{
		...
		public static Dictionary<Guid, string> GetContactsByEmails(UserConnection userConnection, List<string> emails) {
			...
			var select = new Select(userConnection)
				...
				.And("CommunicationTypeId").IsEqual(Column.Const(Guid.Parse(CommunicationTypeConsts.EmailId)))
				.And().OpenBlock("SearchNumber").IsNotEqual(Column.Const(string.Empty))
