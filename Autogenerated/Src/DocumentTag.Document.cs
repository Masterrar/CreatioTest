namespace Terrasoft.Configuration
{
	...
	public class DocumentTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DocumentTag_DocumentEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DocumentTag_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : DocumentTag
	{
