namespace Terrasoft.Configuration
{
	...
	public class SynchronizationProcessStateSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SynchronizationProcessState_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SynchronizationProcessState_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SynchronizationProcessState
	{
