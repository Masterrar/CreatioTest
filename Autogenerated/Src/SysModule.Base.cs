namespace Terrasoft.Configuration
{
	...
	public class SysModuleSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysModule_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysModule_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModule
	{
