namespace Terrasoft.Configuration
{
	...
	public class ContactSalutationType_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ContactSalutationType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ContactSalutationType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ContactSalutationType_Base_Terrasoft
	{
