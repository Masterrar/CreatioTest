namespace Terrasoft.Configuration
{
	...
	public class SysModuleActionLczOldSchema : Terrasoft.Configuration.BaseLczEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysModuleActionLczOld_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysModuleActionLczOld_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLczEntity_BaseEventsProcess<TEntity> where TEntity : SysModuleActionLczOld
	{
