namespace Terrasoft.Configuration
{
	...
	public class MLModelTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new MLModelTag_MLEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class MLModelTag_MLEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : MLModelTag
	{
