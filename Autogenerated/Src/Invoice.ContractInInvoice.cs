namespace Terrasoft.Configuration
{
	...
	public class Invoice_ContractInInvoice_TerrasoftSchema : Terrasoft.Configuration.Invoice_Order_TerrasoftSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Invoice_ContractInInvoiceEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Invoice_ContractInInvoiceEventsProcess<TEntity> : Terrasoft.Configuration.Invoice_OrderEventsProcess<TEntity> where TEntity : Invoice_ContractInInvoice_Terrasoft
	{
