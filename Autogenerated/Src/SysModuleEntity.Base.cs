namespace Terrasoft.Configuration
{
	...
	public class SysModuleEntity_Base_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysModuleEntity_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysModuleEntity_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleEntity_Base_Terrasoft
	{
