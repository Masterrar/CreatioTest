namespace Terrasoft.Configuration
{
	...
	public class LookupInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new LookupInTag_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class LookupInTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : LookupInTag
	{
