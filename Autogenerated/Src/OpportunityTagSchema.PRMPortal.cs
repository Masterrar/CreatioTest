namespace Terrasoft.Configuration
{
	...
	public class OpportunityTagSchema : Terrasoft.Configuration.OpportunityTag_Opportunity_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityTagEventsProcessSchema();
		}
	...
	#region Class: OpportunityTagEventsProcessSchema

	/// <exclude/>
	public class OpportunityTagEventsProcessSchema : Terrasoft.Configuration.OpportunityTag_Opportunity_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityTag_PRMPortalEventsProcess";
			UId = new Guid("03817b14-34ca-41dc-bf68-f5687c4c3bd4");
			CreatedInPackageId = new Guid("580620fc-064a-4cdc-95d9-80175a4d3b0d");
			...
			ParentSchemaUId = new Guid("02db9875-6772-4aaa-a43f-ee23e4d95d4a");
		...
		public override object Clone() {
			return new OpportunityTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("03817b14-34ca-41dc-bf68-f5687c4c3bd4"));
		}
