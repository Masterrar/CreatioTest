namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CommunicationType_SSPEventsProcess<TEntity> : Terrasoft.Configuration.CommunicationType_BaseEventsProcess<TEntity> where TEntity : CommunicationType
	{
