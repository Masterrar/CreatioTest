namespace Terrasoft.Configuration
{
	...
	public class SysOrderDirectionSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysOrderDirection_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysOrderDirection_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysOrderDirection
	{
