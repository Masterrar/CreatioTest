namespace Terrasoft.Configuration
{
	...
	public class ServicePactInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateServicePactInFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateServicePactInFolderEventsProcessSchema() {
			var schema = new ServicePactInFolderEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ServicePactInFolder_SLMITILServiceEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ServicePactInFolder_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : ServicePactInFolder
	{
	...
	#region Class: ServicePactInFolderEventsProcessSchema

	/// <exclude/>
	public class ServicePactInFolderEventsProcessSchema : Terrasoft.Configuration.BaseItemInFolderEventsProcessSchema
	{

		#region Constructors: Public

		public ServicePactInFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ServicePactInFolderEventsProcessSchema(ServicePactInFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ServicePactInFolder_SLMITILServiceEventsProcess";
			UId = new Guid("b65286a4-24b7-4cee-a86d-08bd3a417238");
			CreatedInPackageId = new Guid("ffa69c6a-c8bb-4a61-bc00-b0bcd40a9862");
		...
		public override object Clone() {
			return new ServicePactInFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b65286a4-24b7-4cee-a86d-08bd3a417238"));
		}
