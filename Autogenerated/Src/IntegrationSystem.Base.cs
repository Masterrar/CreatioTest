namespace Terrasoft.Configuration
{
	...
	public class IntegrationSystemSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new IntegrationSystem_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class IntegrationSystem_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : IntegrationSystem
	{
