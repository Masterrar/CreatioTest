namespace Terrasoft.Configuration
{
	...
	public class WSysAccountTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new WSysAccountTag_WebitelCollaborationsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class WSysAccountTag_WebitelCollaborationsEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : WSysAccountTag
	{
