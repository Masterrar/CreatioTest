namespace Terrasoft.Configuration
{
	...
	public class OpportunityFolder_Opportunity_TerrasoftSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new OpportunityFolder_OpportunityEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class OpportunityFolder_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : OpportunityFolder_Opportunity_Terrasoft
	{
