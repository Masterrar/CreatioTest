namespace Terrasoft.Configuration
{
	...
	public class SupplyPaymentElementSchema : Terrasoft.Configuration.SupplyPaymentElement_Passport_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSupplyPaymentElementEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSupplyPaymentElementEventsProcessSchema() {
			var schema = new SupplyPaymentElementEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SupplyPaymentElementEventsProcessSchema

	/// <exclude/>
	public class SupplyPaymentElementEventsProcessSchema : Terrasoft.Configuration.SupplyPaymentElement_Passport_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public SupplyPaymentElementEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SupplyPaymentElementEventsProcessSchema(SupplyPaymentElementEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SupplyPaymentElement_PRMOrderEventsProcess";
			UId = new Guid("fad5df92-44ac-41de-9b28-941c54502f3f");
			CreatedInPackageId = new Guid("f50b1877-37f3-4844-90b8-f493542cdd8d");
		...
		public override object Clone() {
			return new SupplyPaymentElementEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("fad5df92-44ac-41de-9b28-941c54502f3f"));
		}
