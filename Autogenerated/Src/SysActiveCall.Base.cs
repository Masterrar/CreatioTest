namespace Terrasoft.Configuration
{
	...
	public class SysActiveCallSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysActiveCall_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysActiveCall_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysActiveCall
	{
