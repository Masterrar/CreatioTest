namespace Terrasoft.Configuration
{
	...
	public class MapServiceSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new MapService_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class MapService_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : MapService
	{
