namespace Terrasoft.Configuration
{
	...
	public class SiteEventTypeInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSiteEventTypeInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSiteEventTypeInTagEventsProcessSchema() {
			var schema = new SiteEventTypeInTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SiteEventTypeInTag_EventTrackingEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SiteEventTypeInTag_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : SiteEventTypeInTag
	{
	...
	#region Class: SiteEventTypeInTagEventsProcessSchema

	/// <exclude/>
	public class SiteEventTypeInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public SiteEventTypeInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SiteEventTypeInTagEventsProcessSchema(SiteEventTypeInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SiteEventTypeInTag_EventTrackingEventsProcess";
			UId = new Guid("b41298e9-ed5d-4f07-9a87-7abd8db937df");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new SiteEventTypeInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b41298e9-ed5d-4f07-9a87-7abd8db937df"));
		}
