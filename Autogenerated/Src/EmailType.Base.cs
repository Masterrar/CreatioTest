namespace Terrasoft.Configuration
{
	...
	public class EmailTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new EmailType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class EmailType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : EmailType
	{
