namespace Terrasoft.Configuration
{
	...
	public class ProductCategorySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProductCategory_ProductCatalogueEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProductCategory_ProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ProductCategory
	{
