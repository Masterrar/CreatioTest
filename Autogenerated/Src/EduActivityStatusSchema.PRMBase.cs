namespace Terrasoft.Configuration
{
	...
	public class EduActivityStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEduActivityStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEduActivityStatusEventsProcessSchema() {
			var schema = new EduActivityStatusEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: EduActivityStatusEventsProcessSchema

	/// <exclude/>
	public class EduActivityStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public EduActivityStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EduActivityStatusEventsProcessSchema(EduActivityStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EduActivityStatus_PRMBaseEventsProcess";
			UId = new Guid("78f98a83-1d3f-4dba-9012-20e256372412");
			CreatedInPackageId = new Guid("f43a6760-9275-4070-90a5-eacccad59d8c");
		...
		public override object Clone() {
			return new EduActivityStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("78f98a83-1d3f-4dba-9012-20e256372412"));
		}
