namespace Terrasoft.Configuration
{
	...
	public class VwProcessDashboard_ActionsDashboard_TerrasoftSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwProcessDashboard_ActionsDashboardEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwProcessDashboard_ActionsDashboardEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : VwProcessDashboard_ActionsDashboard_Terrasoft
	{
