namespace Terrasoft.Configuration
{
	...
	public class DeduplicateExecLogSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DeduplicateExecLog_DeduplicationEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DeduplicateExecLog_DeduplicationEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : DeduplicateExecLog
	{
