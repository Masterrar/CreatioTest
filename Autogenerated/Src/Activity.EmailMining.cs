namespace Terrasoft.Configuration
{
	...
	public class Activity_EmailMining_TerrasoftSchema : Terrasoft.Configuration.Activity_Exchange_TerrasoftSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Activity_EmailMiningEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Activity_EmailMiningEventsProcess<TEntity> : Terrasoft.Configuration.Activity_ExchangeEventsProcess<TEntity> where TEntity : Activity_EmailMining_Terrasoft
	{
