namespace Terrasoft.Configuration
{
	...
	public class AccountIndustrySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new AccountIndustry_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class AccountIndustry_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : AccountIndustry
	{
