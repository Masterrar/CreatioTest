namespace Terrasoft.Configuration
{
	...
	public class ActivityPrioritySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ActivityPriority_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ActivityPriority_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ActivityPriority
	{
