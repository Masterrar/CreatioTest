namespace Terrasoft.Configuration
{
	...
	public class SysLDAPSynchGroupSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysLDAPSynchGroup_LDAPEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysLDAPSynchGroup_LDAPEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : SysLDAPSynchGroup
	{
