namespace Terrasoft.Configuration
{
	...
	public class AccountFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new AccountFolder_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class AccountFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : AccountFolder
	{
