namespace Terrasoft.Configuration
{
	...
	public class CaseCategorySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCaseCategoryEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCaseCategoryEventsProcessSchema() {
			var schema = new CaseCategoryEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CaseCategory_CaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CaseCategory_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CaseCategory
	{
	...
	#region Class: CaseCategoryEventsProcessSchema

	/// <exclude/>
	public class CaseCategoryEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public CaseCategoryEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CaseCategoryEventsProcessSchema(CaseCategoryEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CaseCategory_CaseEventsProcess";
			UId = new Guid("0f56236f-4911-42ea-bf3c-4a10b594c9e0");
			CreatedInPackageId = new Guid("ffa69c6a-c8bb-4a61-bc00-b0bcd40a9862");
		...
		public override object Clone() {
			return new CaseCategoryEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0f56236f-4911-42ea-bf3c-4a10b594c9e0"));
		}
