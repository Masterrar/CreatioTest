namespace Terrasoft.Configuration
{
	...
	public class SysProcessStatus_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysProcessStatus_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysProcessStatus_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SysProcessStatus_Base_Terrasoft
	{
