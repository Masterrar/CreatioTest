namespace Terrasoft.Configuration
{
	...
	public class VwUserRemindingsCountSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwUserRemindingsCount_NUIEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwUserRemindingsCount_NUIEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : VwUserRemindingsCount
	{
