namespace Terrasoft.Configuration
{
	...
	public class CampaignPlannerTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignPlannerTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignPlannerTypeEventsProcessSchema() {
			var schema = new CampaignPlannerTypeEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignPlannerType_CampaignPlannerNewEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignPlannerType_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignPlannerType
	{
	...
	#region Class: CampaignPlannerTypeEventsProcessSchema

	/// <exclude/>
	public class CampaignPlannerTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignPlannerTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignPlannerTypeEventsProcessSchema(CampaignPlannerTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignPlannerType_CampaignPlannerNewEventsProcess";
			UId = new Guid("120ebd6b-bb0e-46af-98c3-ba9d4bb6bae9");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new CampaignPlannerTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("120ebd6b-bb0e-46af-98c3-ba9d4bb6bae9"));
		}
