namespace Terrasoft.Configuration
{
	...
	public class ProductFolderSchema : Terrasoft.Configuration.ProductFolder_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProductFolderEventsProcessSchema();
		}
	...
	#region Class: ProductFolderEventsProcessSchema

	/// <exclude/>
	public class ProductFolderEventsProcessSchema : Terrasoft.Configuration.ProductFolder_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public ProductFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProductFolder_PRMOrderEventsProcess";
			UId = new Guid("668afc5c-3fa1-4b6e-b231-2544bf23b36b");
			CreatedInPackageId = new Guid("e575b496-539f-4b26-8ba5-4be2dab7e3d9");
			...
			ParentSchemaUId = new Guid("1c6d0b65-f2e0-42c6-8c30-8eb0a904fb72");
		...
		public override object Clone() {
			return new ProductFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("668afc5c-3fa1-4b6e-b231-2544bf23b36b"));
		}
