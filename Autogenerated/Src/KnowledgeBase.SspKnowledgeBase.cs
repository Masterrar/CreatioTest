namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBase_SspKnowledgeBase_TerrasoftSchema : Terrasoft.Configuration.KnowledgeBase_Base_TerrasoftSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new KnowledgeBase_SspKnowledgeBaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class KnowledgeBase_SspKnowledgeBaseEventsProcess<TEntity> : Terrasoft.Configuration.KnowledgeBase_BaseEventsProcess<TEntity> where TEntity : KnowledgeBase_SspKnowledgeBase_Terrasoft
	{
