namespace Terrasoft.Configuration
{
	...
	public class CompetitorProductSchema : Terrasoft.Configuration.CompetitorProduct_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCompetitorProductEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCompetitorProductEventsProcessSchema() {
			var schema = new CompetitorProductEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: CompetitorProductEventsProcessSchema

	/// <exclude/>
	public class CompetitorProductEventsProcessSchema : Terrasoft.Configuration.CompetitorProduct_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public CompetitorProductEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CompetitorProductEventsProcessSchema(CompetitorProductEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CompetitorProduct_PRMPortalEventsProcess";
			UId = new Guid("a7433ee3-269b-4992-999f-e863a697d8a5");
			CreatedInPackageId = new Guid("667fe825-207f-46da-8fb7-a082f81fd079");
			...
			ParentSchemaUId = new Guid("a2b2082c-c264-4588-8f9a-a618cd417d13");
		...
		public override object Clone() {
			return new CompetitorProductEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a7433ee3-269b-4992-999f-e863a697d8a5"));
		}
