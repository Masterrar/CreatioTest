		...
		public ProcessToken ExclusiveGateway1SubProcess1Token {
			get {
				return _exclusiveGateway1SubProcess1Token ?? (_exclusiveGateway1SubProcess1Token = new ProcessToken(UserConnection) {
					...
					SchemaElementUId = new Guid("9b13f3e1-70fb-40e2-8b21-705c49694455"),
					CreatedInSchemaUId = InternalSchemaUId,
					ExecutedEventHandler = OnExecuted,
				});
			}
		...
		private void OnExecuted(object sender, ProcessActivityAfterEventArgs e) {
			switch (e.Context.SenderName) {
					...
					case "ReadActivityDataUser":
						...
						Log.ErrorFormat(DeadEndGatewayLogMessage, "ReadActivityDataUser");
						break;
					case "SubProcess1":
							e.Context.QueueTasksV2.Enqueue(new ProcessQueueElement("Terminate1", e.Context.SenderName));
						Log.ErrorFormat(DeadEndGatewayLogMessage, "SubProcess1");
						break;
					case "StartSignal2":
