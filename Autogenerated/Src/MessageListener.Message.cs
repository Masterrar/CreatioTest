namespace Terrasoft.Configuration
{
	...
	public class MessageListenerSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new MessageListener_MessageEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class MessageListener_MessageEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MessageListener
	{
