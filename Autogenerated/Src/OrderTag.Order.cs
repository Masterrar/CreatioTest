namespace Terrasoft.Configuration
{
	...
	public class OrderTag_Order_TerrasoftSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new OrderTag_OrderEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class OrderTag_OrderEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : OrderTag_Order_Terrasoft
	{
