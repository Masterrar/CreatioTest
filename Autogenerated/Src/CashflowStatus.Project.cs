namespace Terrasoft.Configuration
{
	...
	public class CashflowStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CashflowStatus_ProjectEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CashflowStatus_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CashflowStatus
	{
