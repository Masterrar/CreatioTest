namespace Terrasoft.Configuration
{
	...
	public class OrderInTagSchema : Terrasoft.Configuration.OrderInTag_Order_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOrderInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOrderInTagEventsProcessSchema() {
			var schema = new OrderInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OrderInTagEventsProcessSchema

	/// <exclude/>
	public class OrderInTagEventsProcessSchema : Terrasoft.Configuration.OrderInTag_Order_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OrderInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OrderInTagEventsProcessSchema(OrderInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OrderInTag_PRMOrderEventsProcess";
			UId = new Guid("c572b506-5a53-4bf8-ae43-229a3ce79eba");
			CreatedInPackageId = new Guid("c09bcc89-cd4a-49df-a8fa-3a15879bc3c5");
			...
			ParentSchemaUId = new Guid("3331d037-8991-49f5-8cf0-728059be989f");
		...
		public override object Clone() {
			return new OrderInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c572b506-5a53-4bf8-ae43-229a3ce79eba"));
		}
