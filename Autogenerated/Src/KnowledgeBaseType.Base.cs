namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBaseTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new KnowledgeBaseType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class KnowledgeBaseType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : KnowledgeBaseType
	{
