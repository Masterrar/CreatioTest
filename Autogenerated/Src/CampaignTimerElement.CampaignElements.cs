namespace Terrasoft.Configuration
{
	...
	public class CampaignTimerElement : CampaignSchemaElement, IScheduledExecutionCondition
	{
		...
		protected override Guid Action {
			get {
				return CampaignConsts.CampaignLogTypeTimer;
			}
		}
		...
		public StartTimerEventExpresionType ExpressionType {
			get;
			set;
		}
		...
		protected override void ApplyMetaDataValue(DataReader reader) {
			...
			switch (reader.CurrentName) {
				...
				case TimeZoneOffsetPropertyName:
					var timeZoneString = reader.GetValue<string>();
					try {
						TimeZoneOffset = TimeZoneInfo.FindSystemTimeZoneById(timeZoneString);
					} catch (TimeZoneNotFoundException ex) {
						TimeZoneOffset = CalculatedTimeZone;
					}
					break;
