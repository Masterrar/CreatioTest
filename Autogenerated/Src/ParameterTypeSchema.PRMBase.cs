namespace Terrasoft.Configuration
{
	...
	public class ParameterTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateParameterTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateParameterTypeEventsProcessSchema() {
			var schema = new ParameterTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ParameterTypeEventsProcessSchema

	/// <exclude/>
	public class ParameterTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ParameterTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ParameterTypeEventsProcessSchema(ParameterTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ParameterType_PRMBaseEventsProcess";
			UId = new Guid("47f91bb4-c547-4e33-a5e8-5c7cf26a65f8");
			CreatedInPackageId = new Guid("867b9a25-86bf-4a3e-8ecd-b6e40f57be82");
		...
		public override object Clone() {
			return new ParameterTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("47f91bb4-c547-4e33-a5e8-5c7cf26a65f8"));
		}
