namespace Terrasoft.Configuration
{
	...
	public class DuplicatesRuleTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DuplicatesRuleTag_DeduplicationEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DuplicatesRuleTag_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : DuplicatesRuleTag
	{
