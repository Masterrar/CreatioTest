namespace Terrasoft.Configuration
{
	...
	public class SysExtServiceOperationRightSchema : Terrasoft.Configuration.SysEntitySchemaOperationRightSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysExtServiceOperationRight_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysExtServiceOperationRight_BaseEventsProcess<TEntity> : Terrasoft.Configuration.SysEntitySchemaOperationRight_BaseEventsProcess<TEntity> where TEntity : SysExtServiceOperationRight
	{
