namespace Terrasoft.Configuration
{
	...
	public class LocationHistorySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("b5387ae7-874c-418a-9758-e7de5036e228")) == null) {
				Columns.Add(CreateLongitudeColumn());
			}
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new LocationHistory_MobileEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class LocationHistory_MobileEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : LocationHistory
	{
