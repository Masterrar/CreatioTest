namespace Terrasoft.Configuration
{
	...
	public class PRMTransactionTypeSchema : Terrasoft.Configuration.PRMTransactionType_PRMBase_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePRMTransactionTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePRMTransactionTypeEventsProcessSchema() {
			var schema = new PRMTransactionTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: PRMTransactionTypeEventsProcessSchema

	/// <exclude/>
	public class PRMTransactionTypeEventsProcessSchema : Terrasoft.Configuration.PRMTransactionType_PRMBase_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public PRMTransactionTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PRMTransactionTypeEventsProcessSchema(PRMTransactionTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "PRMTransactionType_PRMPortalEventsProcess";
			UId = new Guid("76b12910-f956-40e1-985e-ae4f1e789464");
			CreatedInPackageId = new Guid("0fffc5a3-cd85-4e12-bfdb-f47322f14e3d");
			...
			ParentSchemaUId = new Guid("f24de152-b281-4812-b592-e907bbfad4b3");
		...
		public override object Clone() {
			return new PRMTransactionTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("76b12910-f956-40e1-985e-ae4f1e789464"));
		}
