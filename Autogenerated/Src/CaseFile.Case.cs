namespace Terrasoft.Configuration
{
	...
	public class CaseFile_Case_TerrasoftSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCaseFile_Case_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCaseFile_Case_TerrasoftEventsProcessSchema() {
			var schema = new CaseFile_Case_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CaseFile_CaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CaseFile_CaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : CaseFile_Case_Terrasoft
	{
	...
	#region Class: CaseFile_Case_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class CaseFile_Case_TerrasoftEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public CaseFile_Case_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CaseFile_Case_TerrasoftEventsProcessSchema(CaseFile_Case_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CaseFile_CaseEventsProcess";
			UId = new Guid("13fb4dde-6869-4210-9b9c-69e11c081f82");
			CreatedInPackageId = new Guid("e9cdff4a-a92d-4d26-906f-df90167f5485");
		...
		public override object Clone() {
			return new CaseFile_Case_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("13fb4dde-6869-4210-9b9c-69e11c081f82"));
		}
