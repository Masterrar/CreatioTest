namespace Terrasoft.Configuration
{
	...
	public class ReleaseFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateReleaseFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateReleaseFolderEventsProcessSchema() {
			var schema = new ReleaseFolderEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ReleaseFolder_ReleaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ReleaseFolder_ReleaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ReleaseFolder
	{
	...
	#region Class: ReleaseFolderEventsProcessSchema

	/// <exclude/>
	public class ReleaseFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public ReleaseFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ReleaseFolderEventsProcessSchema(ReleaseFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ReleaseFolder_ReleaseEventsProcess";
			UId = new Guid("f646a2e5-6caf-4bf9-9996-e6d5b4f116e6");
		...
		public override object Clone() {
			return new ReleaseFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f646a2e5-6caf-4bf9-9996-e6d5b4f116e6"));
		}
