namespace Terrasoft.Configuration
{
	...
	public class Account_Completeness_TerrasoftSchema : Terrasoft.Configuration.Account_EmailMining_TerrasoftSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Account_CompletenessEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Account_CompletenessEventsProcess<TEntity> : Terrasoft.Configuration.Account_EmailMiningEventsProcess<TEntity> where TEntity : Account_Completeness_Terrasoft
	{
