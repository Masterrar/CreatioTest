namespace Terrasoft.Configuration
{
	...
	public class AccountEmployeesNumberSchema : Terrasoft.Configuration.AccountEmployeesNumber_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAccountEmployeesNumberEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateAccountEmployeesNumberEventsProcessSchema() {
			var schema = new AccountEmployeesNumberEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: AccountEmployeesNumberEventsProcessSchema

	/// <exclude/>
	public class AccountEmployeesNumberEventsProcessSchema : Terrasoft.Configuration.AccountEmployeesNumber_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public AccountEmployeesNumberEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public AccountEmployeesNumberEventsProcessSchema(AccountEmployeesNumberEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "AccountEmployeesNumber_PRMPortalEventsProcess";
			UId = new Guid("58b7ec78-794d-42ee-a1e6-06688e04e7f4");
			CreatedInPackageId = new Guid("10676561-1f93-46bf-90be-fe5cd67025e0");
			...
			ParentSchemaUId = new Guid("ef446e70-bb51-48d5-b22a-1a54609041de");
		...
		public override object Clone() {
			return new AccountEmployeesNumberEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("58b7ec78-794d-42ee-a1e6-06688e04e7f4"));
		}
