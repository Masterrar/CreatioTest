namespace Terrasoft.Configuration
{
	...
	public class BulkEmailTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBulkEmailTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBulkEmailTagEventsProcessSchema() {
			var schema = new BulkEmailTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BulkEmailTag_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BulkEmailTag_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : BulkEmailTag
	{
	...
	#region Class: BulkEmailTagEventsProcessSchema

	/// <exclude/>
	public class BulkEmailTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public BulkEmailTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BulkEmailTagEventsProcessSchema(BulkEmailTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BulkEmailTag_MarketingCampaignEventsProcess";
			UId = new Guid("44d9b2ba-253e-4a1a-856c-1410e8e2d507");
			CreatedInPackageId = new Guid("b7874c9a-6e65-41ca-b21f-5fb1f6a22855");
		...
		public override object Clone() {
			return new BulkEmailTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("44d9b2ba-253e-4a1a-856c-1410e8e2d507"));
		}
