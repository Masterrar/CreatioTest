namespace Terrasoft.Configuration
{
	...
	public class ServicePactInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateServicePactInTagEventsProcessSchema();
		}
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ServicePactInTag_SLMITILServiceEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ServicePactInTag_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ServicePactInTag
	{
	...
	#region Class: ServicePactInTagEventsProcessSchema

	/// <exclude/>
	public class ServicePactInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public ServicePactInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ServicePactInTag_SLMITILServiceEventsProcess";
			UId = new Guid("61949635-5438-4dc0-bed6-5008cf9416f3");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ServicePactInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("61949635-5438-4dc0-bed6-5008cf9416f3"));
		}
