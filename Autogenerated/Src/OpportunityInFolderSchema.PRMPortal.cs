namespace Terrasoft.Configuration
{
	...
	public class OpportunityInFolderSchema : Terrasoft.Configuration.OpportunityInFolder_Opportunity_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityInFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOpportunityInFolderEventsProcessSchema() {
			var schema = new OpportunityInFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OpportunityInFolderEventsProcessSchema

	/// <exclude/>
	public class OpportunityInFolderEventsProcessSchema : Terrasoft.Configuration.OpportunityInFolder_Opportunity_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityInFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OpportunityInFolderEventsProcessSchema(OpportunityInFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityInFolder_PRMPortalEventsProcess";
			UId = new Guid("f93e4af1-96eb-4fdc-a229-c7e3c29a8c81");
			CreatedInPackageId = new Guid("580620fc-064a-4cdc-95d9-80175a4d3b0d");
		...
		public override object Clone() {
			return new OpportunityInFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f93e4af1-96eb-4fdc-a229-c7e3c29a8c81"));
		}
