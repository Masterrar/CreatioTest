namespace Terrasoft.Configuration
{
	...
	public class EmployeeFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new EmployeeFile_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class EmployeeFile_BaseEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : EmployeeFile
	{
