namespace Terrasoft.Configuration
{
	...
	public class SysModuleEditSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysModuleEdit_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysModuleEdit_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleEdit
	{
