namespace Terrasoft.Configuration
{
	...
	public class BrandSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Brand_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Brand_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : Brand
	{
