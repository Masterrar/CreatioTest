namespace Terrasoft.Configuration
{
	...
	public class JobChangeReasonSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new JobChangeReason_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class JobChangeReason_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : JobChangeReason
	{
