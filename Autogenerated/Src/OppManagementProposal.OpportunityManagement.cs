...
4. Printables.",
			...
			var applicationParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("59ace551-14f6-469c-affc-8b70cd673c59"),
				ContainerUId = new Guid("42b432bf-8737-414d-84e3-ab7c397ddc30"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b5c726f2-af5b-4381-bac6-913074144308"),
			...
			var finApplicationParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("81048558-3dd2-49b1-bd23-8d84a0f063d6"),
				ContainerUId = new Guid("42b432bf-8737-414d-84e3-ab7c397ddc30"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b5c726f2-af5b-4381-bac6-913074144308"),
		...
		protected virtual void InitializeActivityUserTask3Parameters(IParametrizedProcessSchemaElement parametrizedElement) {
			...
			parametrizedElement.Parameters.Add(queueItemParameter);
			var applicationParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("0e9330a5-5649-4eb8-8986-9bd542f5df02"),
				ContainerUId = new Guid("5ae886c1-831c-4f44-998b-490409f3db7e"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b5c726f2-af5b-4381-bac6-913074144308"),
			...
			parametrizedElement.Parameters.Add(applicationParameter);
			var finApplicationParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("5dedcaa8-462b-46c0-a4cd-99997e69519b"),
				ContainerUId = new Guid("5ae886c1-831c-4f44-998b-490409f3db7e"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b5c726f2-af5b-4381-bac6-913074144308"),
	...
	public class OppManagementProposal : Terrasoft.Core.Process.Process
	{
		...
		private void OnExecuted(object sender, ProcessActivityAfterEventArgs e) {
			switch (e.Context.SenderName) {
					...
					case "ActivityUserTask1":
						if (ActivityUserTask1.ActivityResult == new Guid("632afdd2-f616-4ea6-87d2-8ed38eed8aff") || ActivityUserTask1.ActivityResult == new Guid("dbbf0e10-f46b-1410-6598-00155d043204")) {
					...
					case "ActivityUserTask3":
						if (ActivityUserTask3.ActivityResult == new Guid("dbbf0e10-f46b-1410-6598-00155d043204") || ActivityUserTask3.ActivityResult == new Guid("632afdd2-f616-4ea6-87d2-8ed38eed8aff")) {
							e.Context.QueueTasksV2.Enqueue(new ProcessQueueElement("Terminate1", e.Context.SenderName));
							break;
						}
						if (ActivityUserTask3.ActivityResult == new Guid("d87d32bc-f36b-1410-6598-00155d043204")) {
							e.Context.QueueTasksV2.Enqueue(new ProcessQueueElement("ActivityUserTask1", e.Context.SenderName));
							break;
						}
						break;
		...
		protected override void InitializeMetaPathParameterValues() {
			...
			MetaPathParameterValues.Add("59ace551-14f6-469c-affc-8b70cd673c59", () => ActivityUserTask1.Application);
			MetaPathParameterValues.Add("81048558-3dd2-49b1-bd23-8d84a0f063d6", () => ActivityUserTask1.FinApplication);
			...
			MetaPathParameterValues.Add("0e9330a5-5649-4eb8-8986-9bd542f5df02", () => ActivityUserTask3.Application);
			MetaPathParameterValues.Add("5dedcaa8-462b-46c0-a4cd-99997e69519b", () => ActivityUserTask3.FinApplication);
