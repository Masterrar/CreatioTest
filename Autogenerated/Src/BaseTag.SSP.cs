namespace Terrasoft.Configuration
{
	...
	public class BaseTagSchema : Terrasoft.Configuration.BaseTag_Base_TerrasoftSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BaseTag_SSPEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BaseTag_SSPEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_BaseEventsProcess<TEntity> where TEntity : BaseTag
	{
