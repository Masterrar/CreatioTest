namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBaseFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new KnowledgeBaseFolder_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class KnowledgeBaseFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : KnowledgeBaseFolder
	{
