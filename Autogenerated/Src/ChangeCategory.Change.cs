namespace Terrasoft.Configuration
{
	...
	public class ChangeCategorySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateChangeCategoryEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateChangeCategoryEventsProcessSchema() {
			var schema = new ChangeCategoryEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ChangeCategory_ChangeEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ChangeCategory_ChangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ChangeCategory
	{
	...
	#region Class: ChangeCategoryEventsProcessSchema

	/// <exclude/>
	public class ChangeCategoryEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ChangeCategoryEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ChangeCategoryEventsProcessSchema(ChangeCategoryEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ChangeCategory_ChangeEventsProcess";
			UId = new Guid("67af7615-123c-4065-8486-e1ff2dd940f7");
			CreatedInPackageId = new Guid("2496861e-1f72-4434-ab9e-c42503decf6d");
		...
		public override object Clone() {
			return new ChangeCategoryEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("67af7615-123c-4065-8486-e1ff2dd940f7"));
		}
