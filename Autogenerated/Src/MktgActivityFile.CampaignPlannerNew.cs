namespace Terrasoft.Configuration
{
	...
	public class MktgActivityFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateMktgActivityFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateMktgActivityFileEventsProcessSchema() {
			var schema = new MktgActivityFileEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new MktgActivityFile_CampaignPlannerNewEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class MktgActivityFile_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : MktgActivityFile
	{
	...
	#region Class: MktgActivityFileEventsProcessSchema

	/// <exclude/>
	public class MktgActivityFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public MktgActivityFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public MktgActivityFileEventsProcessSchema(MktgActivityFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "MktgActivityFile_CampaignPlannerNewEventsProcess";
			UId = new Guid("7c5c5e08-2644-4acf-8f42-2bf42cf62a2c");
			CreatedInPackageId = new Guid("8a6b5719-da97-4634-8f04-4375bc29ffcf");
		...
		public override object Clone() {
			return new MktgActivityFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("7c5c5e08-2644-4acf-8f42-2bf42cf62a2c"));
		}
