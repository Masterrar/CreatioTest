namespace Terrasoft.Configuration
{
	...
	public class ChangeFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateChangeFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateChangeFileEventsProcessSchema() {
			var schema = new ChangeFileEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ChangeFile_ChangeEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ChangeFile_ChangeEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ChangeFile
	{
	...
	#region Class: ChangeFileEventsProcessSchema

	/// <exclude/>
	public class ChangeFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public ChangeFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ChangeFileEventsProcessSchema(ChangeFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ChangeFile_ChangeEventsProcess";
			UId = new Guid("799a36c6-f3ff-4e5f-8f3b-6a9df698c066");
		...
		public override object Clone() {
			return new ChangeFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("799a36c6-f3ff-4e5f-8f3b-6a9df698c066"));
		}
