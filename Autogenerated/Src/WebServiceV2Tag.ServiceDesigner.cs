namespace Terrasoft.Configuration
{
	...
	public class WebServiceV2TagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new WebServiceV2Tag_ServiceDesignerEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class WebServiceV2Tag_ServiceDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : WebServiceV2Tag
	{
