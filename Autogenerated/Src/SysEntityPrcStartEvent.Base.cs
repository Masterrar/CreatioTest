namespace Terrasoft.Configuration
{
	...
	public class SysEntityPrcStartEventSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysEntityPrcStartEvent_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysEntityPrcStartEvent_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysEntityPrcStartEvent
	{
