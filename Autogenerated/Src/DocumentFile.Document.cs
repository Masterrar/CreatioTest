namespace Terrasoft.Configuration
{
	...
	public class DocumentFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DocumentFile_DocumentEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DocumentFile_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : DocumentFile
	{
