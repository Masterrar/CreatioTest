namespace Terrasoft.Configuration
{
	...
	public class ForecastRowSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ForecastRow_CoreForecastEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ForecastRow_CoreForecastEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ForecastRow
	{
