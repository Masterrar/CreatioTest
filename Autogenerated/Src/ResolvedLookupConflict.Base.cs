namespace Terrasoft.Configuration
{
	...
	public class ResolvedLookupConflictSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ResolvedLookupConflict_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ResolvedLookupConflict_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ResolvedLookupConflict
	{
