namespace Terrasoft.Configuration
{
	...
	public class ContactTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ContactTag_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ContactTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ContactTag
	{
