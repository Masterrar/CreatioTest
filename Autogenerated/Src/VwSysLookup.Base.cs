namespace Terrasoft.Configuration
{
	...
	public class VwSysLookupSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwSysLookup_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwSysLookup_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : VwSysLookup
	{
