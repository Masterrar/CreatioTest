namespace Terrasoft.Configuration
{
	...
	public class MktgActivityStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateMktgActivityStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateMktgActivityStatusEventsProcessSchema() {
			var schema = new MktgActivityStatusEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new MktgActivityStatus_CampaignPlannerNewEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class MktgActivityStatus_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MktgActivityStatus
	{
	...
	#region Class: MktgActivityStatusEventsProcessSchema

	/// <exclude/>
	public class MktgActivityStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public MktgActivityStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public MktgActivityStatusEventsProcessSchema(MktgActivityStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "MktgActivityStatus_CampaignPlannerNewEventsProcess";
			UId = new Guid("4f8480cf-416b-44ad-9e97-470c713aeecf");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new MktgActivityStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("4f8480cf-416b-44ad-9e97-470c713aeecf"));
		}
