namespace Terrasoft.Configuration
{
	...
	public class ReleaseInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateReleaseInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateReleaseInTagEventsProcessSchema() {
			var schema = new ReleaseInTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ReleaseInTag_ReleaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ReleaseInTag_ReleaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ReleaseInTag
	{
	...
	#region Class: ReleaseInTagEventsProcessSchema

	/// <exclude/>
	public class ReleaseInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public ReleaseInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ReleaseInTagEventsProcessSchema(ReleaseInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ReleaseInTag_ReleaseEventsProcess";
			UId = new Guid("9a9b29ff-2280-4bf6-84b2-db63ed9983d2");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ReleaseInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9a9b29ff-2280-4bf6-84b2-db63ed9983d2"));
		}
