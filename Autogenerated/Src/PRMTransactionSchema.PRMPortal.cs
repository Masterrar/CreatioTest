namespace Terrasoft.Configuration
{
	...
	public class PRMTransactionSchema : Terrasoft.Configuration.PRMTransaction_PRMBase_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePRMTransactionEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePRMTransactionEventsProcessSchema() {
			var schema = new PRMTransactionEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: PRMTransactionEventsProcessSchema

	/// <exclude/>
	public class PRMTransactionEventsProcessSchema : Terrasoft.Configuration.PRMTransaction_PRMBase_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public PRMTransactionEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PRMTransactionEventsProcessSchema(PRMTransactionEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "PRMTransaction_PRMPortalEventsProcess";
			UId = new Guid("466839ce-9620-44dc-acc1-8d423190503a");
			CreatedInPackageId = new Guid("0fffc5a3-cd85-4e12-bfdb-f47322f14e3d");
			...
			ParentSchemaUId = new Guid("9552baed-3ff9-4e81-bb39-5af02d90244e");
		...
		public override object Clone() {
			return new PRMTransactionEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("466839ce-9620-44dc-acc1-8d423190503a"));
		}
