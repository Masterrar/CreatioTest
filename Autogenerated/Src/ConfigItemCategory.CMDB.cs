namespace Terrasoft.Configuration
{
	...
	public class ConfigItemCategorySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateConfigItemCategoryEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateConfigItemCategoryEventsProcessSchema() {
			var schema = new ConfigItemCategoryEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ConfigItemCategory_CMDBEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ConfigItemCategory_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ConfigItemCategory
	{
	...
	#region Class: ConfigItemCategoryEventsProcessSchema

	/// <exclude/>
	public class ConfigItemCategoryEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ConfigItemCategoryEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ConfigItemCategoryEventsProcessSchema(ConfigItemCategoryEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ConfigItemCategory_CMDBEventsProcess";
			UId = new Guid("fe99455f-0d6b-4d18-9392-11adf30cf5b8");
			CreatedInPackageId = new Guid("3bc94b8f-9e47-4d1d-84d1-651293d36a8b");
		...
		public override object Clone() {
			return new ConfigItemCategoryEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("fe99455f-0d6b-4d18-9392-11adf30cf5b8"));
		}
