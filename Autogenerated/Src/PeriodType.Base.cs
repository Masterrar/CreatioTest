namespace Terrasoft.Configuration
{
	...
	public class PeriodTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new PeriodType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class PeriodType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : PeriodType
	{
