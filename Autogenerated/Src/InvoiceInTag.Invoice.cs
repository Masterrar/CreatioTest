namespace Terrasoft.Configuration
{
	...
	public class InvoiceInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new InvoiceInTag_InvoiceEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class InvoiceInTag_InvoiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : InvoiceInTag
	{
