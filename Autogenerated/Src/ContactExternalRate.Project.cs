namespace Terrasoft.Configuration
{
	...
	public class ContactExternalRateSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ContactExternalRate_ProjectEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ContactExternalRate_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ContactExternalRate
	{
