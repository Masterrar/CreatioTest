namespace Terrasoft.Configuration
{
	...
	public class BulkEmailEventResultSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBulkEmailEventResultEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBulkEmailEventResultEventsProcessSchema() {
			var schema = new BulkEmailEventResultEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BulkEmailEventResult_BulkEmailEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BulkEmailEventResult_BulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BulkEmailEventResult
	{
	...
	#region Class: BulkEmailEventResultEventsProcessSchema

	/// <exclude/>
	public class BulkEmailEventResultEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public BulkEmailEventResultEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BulkEmailEventResultEventsProcessSchema(BulkEmailEventResultEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BulkEmailEventResult_BulkEmailEventsProcess";
			UId = new Guid("aef64542-6f26-4a85-ad88-90a2a313151f");
			CreatedInPackageId = new Guid("047a9257-bd59-41e6-8705-ec422d051419");
		...
		public override object Clone() {
			return new BulkEmailEventResultEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("aef64542-6f26-4a85-ad88-90a2a313151f"));
		}
