namespace Terrasoft.Configuration
{
	...
	public class BaseEntityNotesSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BaseEntityNotes_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BaseEntityNotes_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BaseEntityNotes
	{
