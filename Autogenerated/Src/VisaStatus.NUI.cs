namespace Terrasoft.Configuration
{
	...
	public class VisaStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VisaStatus_NUIEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VisaStatus_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : VisaStatus
	{
