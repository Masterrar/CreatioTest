namespace Terrasoft.Configuration
{
	...
	public class LeadProductSchema : Terrasoft.Configuration.LeadProduct_CoreLead_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLeadProductEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLeadProductEventsProcessSchema() {
			var schema = new LeadProductEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: LeadProductEventsProcessSchema

	/// <exclude/>
	public class LeadProductEventsProcessSchema : Terrasoft.Configuration.LeadProduct_CoreLead_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public LeadProductEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LeadProductEventsProcessSchema(LeadProductEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LeadProduct_PRMPortalEventsProcess";
			UId = new Guid("c493958f-682d-4048-8633-ef75e9cff3a8");
			CreatedInPackageId = new Guid("10676561-1f93-46bf-90be-fe5cd67025e0");
			...
			ParentSchemaUId = new Guid("e509f106-c479-405e-a7d3-0f06c8171096");
		...
		public override object Clone() {
			return new LeadProductEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c493958f-682d-4048-8633-ef75e9cff3a8"));
		}
