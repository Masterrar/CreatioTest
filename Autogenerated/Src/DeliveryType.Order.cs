namespace Terrasoft.Configuration
{
	...
	public class DeliveryTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DeliveryType_OrderEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DeliveryType_OrderEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DeliveryType
	{
