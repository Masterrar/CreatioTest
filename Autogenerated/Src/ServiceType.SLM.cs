namespace Terrasoft.Configuration
{
	...
	public class ServiceTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateServiceTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateServiceTypeEventsProcessSchema() {
			var schema = new ServiceTypeEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ServiceType_SLMEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ServiceType_SLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ServiceType
	{
	...
	#region Class: ServiceTypeEventsProcessSchema

	/// <exclude/>
	public class ServiceTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ServiceTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ServiceTypeEventsProcessSchema(ServiceTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ServiceType_SLMEventsProcess";
			UId = new Guid("7654d897-8d00-4280-9349-37e76d6274f1");
			CreatedInPackageId = new Guid("ffa69c6a-c8bb-4a61-bc00-b0bcd40a9862");
		...
		public override object Clone() {
			return new ServiceTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("7654d897-8d00-4280-9349-37e76d6274f1"));
		}
