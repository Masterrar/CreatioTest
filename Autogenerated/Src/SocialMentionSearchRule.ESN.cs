namespace Terrasoft.Configuration
{
	...
	public class SocialMentionSearchRuleSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SocialMentionSearchRule_ESNEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SocialMentionSearchRule_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SocialMentionSearchRule
	{
