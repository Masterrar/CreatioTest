namespace Terrasoft.Configuration
{
	...
	public class Activity_CMDB_TerrasoftSchema : Terrasoft.Configuration.Activity_Opportunity_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateActivity_CMDB_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateActivity_CMDB_TerrasoftEventsProcessSchema() {
			var schema = new Activity_CMDB_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Activity_CMDBEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Activity_CMDBEventsProcess<TEntity> : Terrasoft.Configuration.Activity_OpportunityEventsProcess<TEntity> where TEntity : Activity_CMDB_Terrasoft
	{
	...
	#region Class: Activity_CMDB_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class Activity_CMDB_TerrasoftEventsProcessSchema : Terrasoft.Configuration.Activity_Opportunity_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public Activity_CMDB_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public Activity_CMDB_TerrasoftEventsProcessSchema(Activity_CMDB_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Activity_CMDBEventsProcess";
			UId = new Guid("96cb29a9-1127-4cd8-adbb-f569e7318412");
			CreatedInPackageId = new Guid("f903ed7d-efff-4bea-98a9-8ff46e81b434");
		...
		public override object Clone() {
			return new Activity_CMDB_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("96cb29a9-1127-4cd8-adbb-f569e7318412"));
		}
