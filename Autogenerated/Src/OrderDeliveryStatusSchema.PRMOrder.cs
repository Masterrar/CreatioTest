namespace Terrasoft.Configuration
{
	...
	public class OrderDeliveryStatusSchema : Terrasoft.Configuration.OrderDeliveryStatus_Order_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOrderDeliveryStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOrderDeliveryStatusEventsProcessSchema() {
			var schema = new OrderDeliveryStatusEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OrderDeliveryStatusEventsProcessSchema

	/// <exclude/>
	public class OrderDeliveryStatusEventsProcessSchema : Terrasoft.Configuration.OrderDeliveryStatus_Order_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OrderDeliveryStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OrderDeliveryStatusEventsProcessSchema(OrderDeliveryStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OrderDeliveryStatus_PRMOrderEventsProcess";
			UId = new Guid("c4f1188e-9446-4fee-8916-2659042b2b3f");
			CreatedInPackageId = new Guid("c09bcc89-cd4a-49df-a8fa-3a15879bc3c5");
			...
			ParentSchemaUId = new Guid("04a649eb-98de-4d99-95cf-ef0a855d7a4f");
		...
		public override object Clone() {
			return new OrderDeliveryStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c4f1188e-9446-4fee-8916-2659042b2b3f"));
		}
