namespace Terrasoft.Configuration
{
	...
	public class DuplicatesHistorySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DuplicatesHistory_DeduplicationEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DuplicatesHistory_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : DuplicatesHistory
	{
