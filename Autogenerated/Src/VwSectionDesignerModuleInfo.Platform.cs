namespace Terrasoft.Configuration
{
	...
	public class VwSectionDesignerModuleInfoSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwSectionDesignerModuleInfo_PlatformEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwSectionDesignerModuleInfo_PlatformEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : VwSectionDesignerModuleInfo
	{
