namespace Terrasoft.Configuration
{
	...
	public class CampaignSignalSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignSignalEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignSignalEventsProcessSchema() {
			var schema = new CampaignSignalEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignSignal_CampaignsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignSignal_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CampaignSignal
	{
	...
	#region Class: CampaignSignalEventsProcessSchema

	/// <exclude/>
	public class CampaignSignalEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignSignalEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignSignalEventsProcessSchema(CampaignSignalEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignSignal_CampaignsEventsProcess";
			UId = new Guid("849b4b01-55c6-4bd5-9793-59997c21582f");
			CreatedInPackageId = new Guid("bac310da-8f6a-4932-87be-74eb3d9d7067");
		...
		public override object Clone() {
			return new CampaignSignalEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("849b4b01-55c6-4bd5-9793-59997c21582f"));
		}
