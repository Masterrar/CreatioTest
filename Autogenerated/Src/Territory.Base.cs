namespace Terrasoft.Configuration
{
	...
	public class TerritorySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Territory_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Territory_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : Territory
	{
