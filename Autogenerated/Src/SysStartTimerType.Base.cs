namespace Terrasoft.Configuration
{
	...
	public class SysStartTimerTypeSchema : Terrasoft.Configuration.SysCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysStartTimerType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysStartTimerType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.SysCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysStartTimerType
	{
