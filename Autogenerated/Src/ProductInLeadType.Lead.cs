namespace Terrasoft.Configuration
{
	...
	public class ProductInLeadTypeSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProductInLeadType_LeadEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProductInLeadType_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ProductInLeadType
	{
