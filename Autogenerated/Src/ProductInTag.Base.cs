namespace Terrasoft.Configuration
{
	...
	public class ProductInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProductInTag_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProductInTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : ProductInTag
	{
