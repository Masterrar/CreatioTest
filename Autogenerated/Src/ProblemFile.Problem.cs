namespace Terrasoft.Configuration
{
	...
	public class ProblemFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProblemFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProblemFileEventsProcessSchema() {
			var schema = new ProblemFileEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProblemFile_ProblemEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProblemFile_ProblemEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : ProblemFile
	{
	...
	#region Class: ProblemFileEventsProcessSchema

	/// <exclude/>
	public class ProblemFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public ProblemFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProblemFileEventsProcessSchema(ProblemFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProblemFile_ProblemEventsProcess";
			UId = new Guid("fa1a683a-3bee-47b6-b369-c2bb443a225a");
			CreatedInPackageId = new Guid("305fcfca-4160-4398-90a9-d5e84be0ae12");
		...
		public override object Clone() {
			return new ProblemFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("fa1a683a-3bee-47b6-b369-c2bb443a225a"));
		}
