namespace Terrasoft.Configuration
{
	...
	public class ServiceItemFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateServiceItemFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateServiceItemFolderEventsProcessSchema() {
			var schema = new ServiceItemFolderEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ServiceItemFolder_SLMEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ServiceItemFolder_SLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ServiceItemFolder
	{
	...
	#region Class: ServiceItemFolderEventsProcessSchema

	/// <exclude/>
	public class ServiceItemFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public ServiceItemFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ServiceItemFolderEventsProcessSchema(ServiceItemFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ServiceItemFolder_SLMEventsProcess";
			UId = new Guid("443ebc88-a8b0-4ac1-8c0e-ec46661c2c2f");
			CreatedInPackageId = new Guid("ffa69c6a-c8bb-4a61-bc00-b0bcd40a9862");
		...
		public override object Clone() {
			return new ServiceItemFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("443ebc88-a8b0-4ac1-8c0e-ec46661c2c2f"));
		}
