namespace Terrasoft.Configuration
{
	...
	public class VwBulkEmailInCampaignSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwBulkEmailInCampaignEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwBulkEmailInCampaignEventsProcessSchema() {
			var schema = new VwBulkEmailInCampaignEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwBulkEmailInCampaign_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwBulkEmailInCampaign_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwBulkEmailInCampaign
	{
	...
	#region Class: VwBulkEmailInCampaignEventsProcessSchema

	/// <exclude/>
	public class VwBulkEmailInCampaignEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public VwBulkEmailInCampaignEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwBulkEmailInCampaignEventsProcessSchema(VwBulkEmailInCampaignEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwBulkEmailInCampaign_MarketingCampaignEventsProcess";
			UId = new Guid("83c0ac65-6039-48c5-8cee-fd6f7a5f0d81");
			CreatedInPackageId = new Guid("6c038aa0-46cd-4697-bc93-5c682e364aef");
		...
		public override object Clone() {
			return new VwBulkEmailInCampaignEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("83c0ac65-6039-48c5-8cee-fd6f7a5f0d81"));
		}
