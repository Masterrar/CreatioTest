namespace Terrasoft.Configuration
{
	...
	public class SupplyPaymentTemplateItem_Passport_TerrasoftSchema : Terrasoft.Configuration.SupplyPaymentSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SupplyPaymentTemplateItem_PassportEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SupplyPaymentTemplateItem_PassportEventsProcess<TEntity> : Terrasoft.Configuration.SupplyPayment_PassportEventsProcess<TEntity> where TEntity : SupplyPaymentTemplateItem_Passport_Terrasoft
	{
