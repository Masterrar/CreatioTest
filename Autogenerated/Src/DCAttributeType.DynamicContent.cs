namespace Terrasoft.Configuration
{
	...
	public class DCAttributeTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDCAttributeTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDCAttributeTypeEventsProcessSchema() {
			var schema = new DCAttributeTypeEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DCAttributeType_DynamicContentEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DCAttributeType_DynamicContentEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DCAttributeType
	{
	...
	#region Class: DCAttributeTypeEventsProcessSchema

	/// <exclude/>
	public class DCAttributeTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public DCAttributeTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DCAttributeTypeEventsProcessSchema(DCAttributeTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DCAttributeType_DynamicContentEventsProcess";
			UId = new Guid("a5b5f0e8-a361-454d-bd88-4e2105bedabc");
			CreatedInPackageId = new Guid("9f77887e-50a7-49c4-86e4-3ef2d36a21a8");
		...
		public override object Clone() {
			return new DCAttributeTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a5b5f0e8-a361-454d-bd88-4e2105bedabc"));
		}
