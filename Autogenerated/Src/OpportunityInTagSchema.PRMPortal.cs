namespace Terrasoft.Configuration
{
	...
	public class OpportunityInTagSchema : Terrasoft.Configuration.OpportunityInTag_Opportunity_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityInTagEventsProcessSchema();
		}
	...
	#region Class: OpportunityInTagEventsProcessSchema

	/// <exclude/>
	public class OpportunityInTagEventsProcessSchema : Terrasoft.Configuration.OpportunityInTag_Opportunity_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityInTag_PRMPortalEventsProcess";
			UId = new Guid("e5e02213-68cf-4488-841f-65846a64c9c6");
			CreatedInPackageId = new Guid("580620fc-064a-4cdc-95d9-80175a4d3b0d");
			...
			ParentSchemaUId = new Guid("eb3cd186-9933-4bb6-bb83-586d99756e1e");
		...
		public override object Clone() {
			return new OpportunityInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e5e02213-68cf-4488-841f-65846a64c9c6"));
		}
