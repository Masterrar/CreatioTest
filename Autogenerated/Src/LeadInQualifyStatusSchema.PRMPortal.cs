namespace Terrasoft.Configuration
{
	...
	public class LeadInQualifyStatusSchema : Terrasoft.Configuration.LeadInQualifyStatus_Lead_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLeadInQualifyStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLeadInQualifyStatusEventsProcessSchema() {
			var schema = new LeadInQualifyStatusEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: LeadInQualifyStatusEventsProcessSchema

	/// <exclude/>
	public class LeadInQualifyStatusEventsProcessSchema : Terrasoft.Configuration.LeadInQualifyStatus_Lead_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public LeadInQualifyStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LeadInQualifyStatusEventsProcessSchema(LeadInQualifyStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LeadInQualifyStatus_PRMPortalEventsProcess";
			UId = new Guid("2e8772fe-1bdf-49dc-80be-8399a04a7218");
			CreatedInPackageId = new Guid("580620fc-064a-4cdc-95d9-80175a4d3b0d");
			...
			ParentSchemaUId = new Guid("2a914d4e-dd35-4d05-a0aa-e096db3484a4");
		...
		public override object Clone() {
			return new LeadInQualifyStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("2e8772fe-1bdf-49dc-80be-8399a04a7218"));
		}
