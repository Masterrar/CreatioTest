namespace Terrasoft.Configuration
{
	...
	public class DeduplicateOperationSchema : Terrasoft.Configuration.LookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DeduplicateOperation_DeduplicationEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DeduplicateOperation_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.Lookup_BaseEventsProcess<TEntity> where TEntity : DeduplicateOperation
	{
