namespace Terrasoft.Configuration
{
	...
	public class ProjectProductSchema : Terrasoft.Configuration.BaseProductEntrySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProjectProduct_ProjectEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProjectProduct_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseProductEntry_ProductCatalogueEventsProcess<TEntity> where TEntity : ProjectProduct
	{
