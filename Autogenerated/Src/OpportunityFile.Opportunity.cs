namespace Terrasoft.Configuration
{
	...
	public class OpportunityFile_Opportunity_TerrasoftSchema : Terrasoft.Configuration.FileSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new OpportunityFile_OpportunityEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class OpportunityFile_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.File_PRMPortalEventsProcess<TEntity> where TEntity : OpportunityFile_Opportunity_Terrasoft
	{
