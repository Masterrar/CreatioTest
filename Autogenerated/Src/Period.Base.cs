namespace Terrasoft.Configuration
{
	...
	public class PeriodSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Period_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Period_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : Period
	{
