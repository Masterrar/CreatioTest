namespace Terrasoft.Configuration
{
	...
	public class OpportunityCompetitorSchema : Terrasoft.Configuration.OpportunityCompetitor_Opportunity_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityCompetitorEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOpportunityCompetitorEventsProcessSchema() {
			var schema = new OpportunityCompetitorEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OpportunityCompetitorEventsProcessSchema

	/// <exclude/>
	public class OpportunityCompetitorEventsProcessSchema : Terrasoft.Configuration.OpportunityCompetitor_Opportunity_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityCompetitorEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OpportunityCompetitorEventsProcessSchema(OpportunityCompetitorEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityCompetitor_PRMPortalEventsProcess";
			UId = new Guid("9b58ef26-008f-4cdd-b7bc-4a1bb5feb635");
			CreatedInPackageId = new Guid("580620fc-064a-4cdc-95d9-80175a4d3b0d");
			...
			ParentSchemaUId = new Guid("c82def12-8f6f-4d7f-bb13-90f68df16c68");
		...
		public override object Clone() {
			return new OpportunityCompetitorEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9b58ef26-008f-4cdd-b7bc-4a1bb5feb635"));
		}
