namespace Terrasoft.Configuration
{
	...
	public class VwOrderProductFilterSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwOrderProductFilter_PassportEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwOrderProductFilter_PassportEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : VwOrderProductFilter
	{
