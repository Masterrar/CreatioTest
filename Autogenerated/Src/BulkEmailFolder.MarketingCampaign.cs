namespace Terrasoft.Configuration
{
	...
	public class BulkEmailFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBulkEmailFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBulkEmailFolderEventsProcessSchema() {
			var schema = new BulkEmailFolderEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BulkEmailFolder_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BulkEmailFolder_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : BulkEmailFolder
	{
	...
	#region Class: BulkEmailFolderEventsProcessSchema

	/// <exclude/>
	public class BulkEmailFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public BulkEmailFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BulkEmailFolderEventsProcessSchema(BulkEmailFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BulkEmailFolder_MarketingCampaignEventsProcess";
			UId = new Guid("6c4d2ddb-d7b7-4b8c-8524-669e3a4fb112");
		...
		public override object Clone() {
			return new BulkEmailFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("6c4d2ddb-d7b7-4b8c-8524-669e3a4fb112"));
		}
