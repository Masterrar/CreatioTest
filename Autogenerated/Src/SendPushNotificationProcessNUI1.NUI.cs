namespace Terrasoft.Core.Process
{
	...
	#region Class: SendPushNotificationProcessNUI1

	/// <exclude/>
	public class SendPushNotificationProcessNUI1 : Terrasoft.Core.Process.Process
	{
		...
		public class ProcessLane1 : ProcessLane
		{
			...
			public ProcessLane1(UserConnection userConnection, SendPushNotificationProcessNUI1 process)
				: base(userConnection) {
				Owner = process;
		...
		public SendPushNotificationProcessNUI1(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SendPushNotificationProcessNUI1";
			SchemaUId = new Guid("8598446b-ce4d-4c2b-85f2-2ba3d3ceca80");
			...
			_entityUId = () => { return (Guid)(Guid.Empty); };
			ProcessModel = new SendPushNotificationProcessNUI1MethodsWrapper(this);
		...
		private Guid InternalSchemaUId {
			get {
				return new Guid("8598446b-ce4d-4c2b-85f2-2ba3d3ceca80");
			}
		}
		...
		private Func<Guid> _entityUId;
		public virtual Guid EntityUId {
			get {
				return (_entityUId ?? (_entityUId = () => Guid.Empty)).Invoke();
			}
			set {
				_entityUId = () => { return value; };
			}
		}
		...
		private void WritePropertyValues(DataWriter writer, bool useAllValueSources) {
			...
			if (!HasMapping("EntityUId")) {
				writer.WriteValue("EntityUId", EntityUId, Guid.Empty);
			}
		}
		...
		protected override void InitializeMetaPathParameterValues() {
			...
			MetaPathParameterValues.Add("1f35dc06-916d-41f0-874c-d450b70d654b", () => EntityUId);
		}
		...
		protected override void ApplyPropertiesDataValues(DataReader reader) {
			...
			switch (reader.CurrentName) {
				...
				case "EntityUId":
					if (!hasValueToRead) break;
					EntityUId = reader.GetValue<System.Guid>();
				break;
			}
		}
		...
		public virtual bool InitEntityNameParamTaskExecute(ProcessExecutingContext context) {
			var localEntityUId = (EntityUId);
			EntityUId = (System.Guid)localEntityUId;
			return true;
		}
		...
		public override object CloneShallow() {
			var cloneItem = (SendPushNotificationProcessNUI1)base.CloneShallow();
