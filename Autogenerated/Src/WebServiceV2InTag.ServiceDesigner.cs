namespace Terrasoft.Configuration
{
	...
	public class WebServiceV2InTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new WebServiceV2InTag_ServiceDesignerEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class WebServiceV2InTag_ServiceDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : WebServiceV2InTag
	{
