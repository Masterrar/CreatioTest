namespace Terrasoft.Configuration
{
	...
	public class LeadRegisterMethodSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new LeadRegisterMethod_LeadEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class LeadRegisterMethod_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadRegisterMethod
	{
