namespace Terrasoft.Configuration
{
	...
	public class FileTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new FileType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class FileType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : FileType
	{
