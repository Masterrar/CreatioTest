namespace Terrasoft.Configuration
{
	...
	public class ClosureCodeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateClosureCodeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateClosureCodeEventsProcessSchema() {
			var schema = new ClosureCodeEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ClosureCode_CaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ClosureCode_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ClosureCode
	{
	...
	#region Class: ClosureCodeEventsProcessSchema

	/// <exclude/>
	public class ClosureCodeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ClosureCodeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ClosureCodeEventsProcessSchema(ClosureCodeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ClosureCode_CaseEventsProcess";
			UId = new Guid("4467da32-55d9-4677-9ab9-cc74a674b2f2");
			CreatedInPackageId = new Guid("e9cdff4a-a92d-4d26-906f-df90167f5485");
		...
		public override object Clone() {
			return new ClosureCodeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("4467da32-55d9-4677-9ab9-cc74a674b2f2"));
		}
