namespace Terrasoft.Configuration
{
	...
	public class VwModuleEditInfoSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwModuleEditInfo_PlatformEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwModuleEditInfo_PlatformEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : VwModuleEditInfo
	{
