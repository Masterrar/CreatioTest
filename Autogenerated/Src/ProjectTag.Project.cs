namespace Terrasoft.Configuration
{
	...
	public class ProjectTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProjectTag_ProjectEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProjectTag_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ProjectTag
	{
