namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class PortalSchemaAccessList_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : PortalSchemaAccessList
	{
