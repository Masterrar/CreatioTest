namespace Terrasoft.Configuration
{
	...
	public class AccountOwnershipSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new AccountOwnership_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class AccountOwnership_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : AccountOwnership
	{
