namespace Terrasoft.Configuration
{
	...
	public class VwOpportunityInStageSchema : Terrasoft.Configuration.OpportunityInStageSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwOpportunityInStage_OpportunityEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwOpportunityInStage_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.OpportunityInStage_PRMPortalEventsProcess<TEntity> where TEntity : VwOpportunityInStage
	{
