namespace Terrasoft.Configuration
{
	...
	public class OpportunityFileSchema : Terrasoft.Configuration.OpportunityFile_Opportunity_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOpportunityFileEventsProcessSchema() {
			var schema = new OpportunityFileEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OpportunityFileEventsProcessSchema

	/// <exclude/>
	public class OpportunityFileEventsProcessSchema : Terrasoft.Configuration.OpportunityFile_Opportunity_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OpportunityFileEventsProcessSchema(OpportunityFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityFile_PRMPortalEventsProcess";
			UId = new Guid("01615e6e-1aeb-4347-8a5f-5e4a6b117a39");
			CreatedInPackageId = new Guid("580620fc-064a-4cdc-95d9-80175a4d3b0d");
			...
			ParentSchemaUId = new Guid("3dabaf7f-1ed2-4ce4-9d02-f8a1291565f7");
		...
		public override object Clone() {
			return new OpportunityFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("01615e6e-1aeb-4347-8a5f-5e4a6b117a39"));
		}
