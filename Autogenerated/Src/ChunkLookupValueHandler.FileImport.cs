namespace Terrasoft.Configuration.FileImport
{
	...
	public class ChunkLookupValuesHandler
	{
		...
		private ImportLookupChunksDataProvider _importDataProvider;
		...
		private ImportLookupChunksDataProvider ImportDataProvider
		{
			get => _importDataProvider ?? (_importDataProvider = ClassFactory.Get<ImportLookupChunksDataProvider>(new ConstructorArgument("userConnection",
						UserConnection)));
		}
