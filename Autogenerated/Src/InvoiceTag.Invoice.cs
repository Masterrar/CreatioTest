namespace Terrasoft.Configuration
{
	...
	public class InvoiceTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new InvoiceTag_InvoiceEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class InvoiceTag_InvoiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : InvoiceTag
	{
