namespace Terrasoft.Configuration
{
	...
	public class SysProcessEntitySchema : Terrasoft.Configuration.SysProcessEntity_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysProcessEntityEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysProcessEntityEventsProcessSchema() {
			var schema = new SysProcessEntityEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysProcessEntityEventsProcessSchema

	/// <exclude/>
	public class SysProcessEntityEventsProcessSchema : Terrasoft.Configuration.SysProcessEntity_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public SysProcessEntityEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysProcessEntityEventsProcessSchema(SysProcessEntityEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysProcessEntity_PRMPortalEventsProcess";
			UId = new Guid("86587515-9af9-420b-8937-3505fb627e61");
			CreatedInPackageId = new Guid("667fe825-207f-46da-8fb7-a082f81fd079");
			...
			ParentSchemaUId = new Guid("142c38e9-8d67-424e-a0bb-fc74d6975167");
		...
		public override object Clone() {
			return new SysProcessEntityEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("86587515-9af9-420b-8937-3505fb627e61"));
		}
