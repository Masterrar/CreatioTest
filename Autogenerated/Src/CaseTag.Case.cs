namespace Terrasoft.Configuration
{
	...
	public class CaseTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCaseTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCaseTagEventsProcessSchema() {
			var schema = new CaseTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CaseTag_CaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CaseTag_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : CaseTag
	{
	...
	#region Class: CaseTagEventsProcessSchema

	/// <exclude/>
	public class CaseTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public CaseTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CaseTagEventsProcessSchema(CaseTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CaseTag_CaseEventsProcess";
			UId = new Guid("9ab005fb-f572-404d-982f-cc09acf76404");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new CaseTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9ab005fb-f572-404d-982f-cc09acf76404"));
		}
