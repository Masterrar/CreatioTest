namespace Terrasoft.Configuration
{
	...
	public class ChangeSourceSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateChangeSourceEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateChangeSourceEventsProcessSchema() {
			var schema = new ChangeSourceEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ChangeSource_ChangeEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ChangeSource_ChangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ChangeSource
	{
	...
	#region Class: ChangeSourceEventsProcessSchema

	/// <exclude/>
	public class ChangeSourceEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ChangeSourceEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ChangeSourceEventsProcessSchema(ChangeSourceEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ChangeSource_ChangeEventsProcess";
			UId = new Guid("0a391322-e7cf-4d62-8db7-ad43c763be3b");
			CreatedInPackageId = new Guid("2496861e-1f72-4434-ab9e-c42503decf6d");
		...
		public override object Clone() {
			return new ChangeSourceEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0a391322-e7cf-4d62-8db7-ad43c763be3b"));
		}
