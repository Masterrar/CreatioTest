namespace Terrasoft.Configuration
{
	...
	public class ProjectFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProjectFolder_ProjectEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProjectFolder_ProjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ProjectFolder
	{
