namespace Terrasoft.Configuration
{
	...
	public class SysModuleActionTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysModuleActionType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysModuleActionType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysModuleActionType
	{
