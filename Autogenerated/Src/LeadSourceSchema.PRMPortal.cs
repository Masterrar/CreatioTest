namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class LeadSourceSchema : Terrasoft.Configuration.LeadSource_Lead_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLeadSourceEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLeadSourceEventsProcessSchema() {
			var schema = new LeadSourceEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// Lead source.
	/// </summary>
	public class LeadSource : Terrasoft.Configuration.LeadSource_Lead_Terrasoft
	{
	...
	/// <exclude/>
	public partial class LeadSource_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.LeadSource_LeadEventsProcess<TEntity> where TEntity : LeadSource
	{
	...
	#region Class: LeadSourceEventsProcessSchema

	/// <exclude/>
	public class LeadSourceEventsProcessSchema : Terrasoft.Configuration.LeadSource_Lead_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public LeadSourceEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LeadSourceEventsProcessSchema(LeadSourceEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LeadSource_PRMPortalEventsProcess";
			UId = new Guid("d648519b-a647-4742-9e56-4e4baa4cfd5d");
			CreatedInPackageId = new Guid("0fffc5a3-cd85-4e12-bfdb-f47322f14e3d");
			...
			ParentSchemaUId = new Guid("187aff5a-88b8-4078-ab61-1833cc08fe22");
		...
		public override object Clone() {
			return new LeadSourceEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("d648519b-a647-4742-9e56-4e4baa4cfd5d"));
		}
