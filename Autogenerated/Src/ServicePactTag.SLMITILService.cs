namespace Terrasoft.Configuration
{
	...
	public class ServicePactTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateServicePactTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateServicePactTagEventsProcessSchema() {
			var schema = new ServicePactTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ServicePactTag_SLMITILServiceEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ServicePactTag_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ServicePactTag
	{
	...
	#region Class: ServicePactTagEventsProcessSchema

	/// <exclude/>
	public class ServicePactTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public ServicePactTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ServicePactTagEventsProcessSchema(ServicePactTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ServicePactTag_SLMITILServiceEventsProcess";
			UId = new Guid("6f326cfe-0392-4890-a808-b0f121a21c4d");
			CreatedInPackageId = new Guid("dfe2c6b5-61e8-4e57-95ae-a3c34fa0908f");
		...
		public override object Clone() {
			return new ServicePactTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("6f326cfe-0392-4890-a808-b0f121a21c4d"));
		}
