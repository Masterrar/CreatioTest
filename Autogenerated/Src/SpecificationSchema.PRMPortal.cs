namespace Terrasoft.Configuration
{
	...
	public class SpecificationSchema : Terrasoft.Configuration.Specification_Specification_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSpecificationEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSpecificationEventsProcessSchema() {
			var schema = new SpecificationEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SpecificationEventsProcessSchema

	/// <exclude/>
	public class SpecificationEventsProcessSchema : Terrasoft.Configuration.Specification_Specification_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public SpecificationEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SpecificationEventsProcessSchema(SpecificationEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Specification_PRMPortalEventsProcess";
			UId = new Guid("78994a12-06b3-420c-9d1e-130cb8f7cecc");
			CreatedInPackageId = new Guid("10676561-1f93-46bf-90be-fe5cd67025e0");
			...
			ParentSchemaUId = new Guid("1b34bce1-36c6-4c1f-b0e6-e5c32dd4819d");
		...
		public override object Clone() {
			return new SpecificationEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("78994a12-06b3-420c-9d1e-130cb8f7cecc"));
		}
