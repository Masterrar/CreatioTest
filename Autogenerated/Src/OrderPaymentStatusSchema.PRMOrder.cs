namespace Terrasoft.Configuration
{
	...
	public class OrderPaymentStatusSchema : Terrasoft.Configuration.OrderPaymentStatus_Order_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOrderPaymentStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOrderPaymentStatusEventsProcessSchema() {
			var schema = new OrderPaymentStatusEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OrderPaymentStatusEventsProcessSchema

	/// <exclude/>
	public class OrderPaymentStatusEventsProcessSchema : Terrasoft.Configuration.OrderPaymentStatus_Order_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OrderPaymentStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OrderPaymentStatusEventsProcessSchema(OrderPaymentStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OrderPaymentStatus_PRMOrderEventsProcess";
			UId = new Guid("8fef2cf3-c953-4acb-bb65-d31642c64687");
			CreatedInPackageId = new Guid("c09bcc89-cd4a-49df-a8fa-3a15879bc3c5");
			...
			ParentSchemaUId = new Guid("e61ddd8c-ef2b-4516-bc58-90753456fc1a");
		...
		public override object Clone() {
			return new OrderPaymentStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("8fef2cf3-c953-4acb-bb65-d31642c64687"));
		}
