namespace Terrasoft.Configuration
{
	...
	public class SysAggregationTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysAggregationType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysAggregationType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_BaseEventsProcess<TEntity> where TEntity : SysAggregationType
	{
