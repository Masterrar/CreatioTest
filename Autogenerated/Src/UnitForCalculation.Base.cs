namespace Terrasoft.Configuration
{
	...
	public class UnitForCalculationSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new UnitForCalculation_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class UnitForCalculation_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : UnitForCalculation
	{
