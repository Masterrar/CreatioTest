namespace Terrasoft.Configuration
{
	...
	public class CampaignStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignStatusEventsProcessSchema() {
			var schema = new CampaignStatusEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignStatus_CampaignsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignStatus_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignStatus
	{
	...
	#region Class: CampaignStatusEventsProcessSchema

	/// <exclude/>
	public class CampaignStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignStatusEventsProcessSchema(CampaignStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignStatus_CampaignsEventsProcess";
			UId = new Guid("73768ac2-3d8a-4aa3-a35a-aab333f9b92e");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new CampaignStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("73768ac2-3d8a-4aa3-a35a-aab333f9b92e"));
		}
