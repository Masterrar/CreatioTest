namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBaseInTagV2Schema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new KnowledgeBaseInTagV2_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class KnowledgeBaseInTagV2_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : KnowledgeBaseInTagV2
	{
