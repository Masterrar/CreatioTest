namespace Terrasoft.Configuration
{
	...
	public class SysLookupSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysLookup_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysLookup_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SysLookup
	{
