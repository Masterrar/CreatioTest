namespace Terrasoft.Configuration
{
	...
	public class BulkEmailInBulkEmailSplitSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBulkEmailInBulkEmailSplitEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBulkEmailInBulkEmailSplitEventsProcessSchema() {
			var schema = new BulkEmailInBulkEmailSplitEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BulkEmailInBulkEmailSplit_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BulkEmailInBulkEmailSplit_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BulkEmailInBulkEmailSplit
	{
	...
	#region Class: BulkEmailInBulkEmailSplitEventsProcessSchema

	/// <exclude/>
	public class BulkEmailInBulkEmailSplitEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public BulkEmailInBulkEmailSplitEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BulkEmailInBulkEmailSplitEventsProcessSchema(BulkEmailInBulkEmailSplitEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BulkEmailInBulkEmailSplit_MarketingCampaignEventsProcess";
			UId = new Guid("88aafa41-41f7-4f1e-adff-2516a8eb8971");
			CreatedInPackageId = new Guid("b7874c9a-6e65-41ca-b21f-5fb1f6a22855");
		...
		public override object Clone() {
			return new BulkEmailInBulkEmailSplitEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("88aafa41-41f7-4f1e-adff-2516a8eb8971"));
		}
