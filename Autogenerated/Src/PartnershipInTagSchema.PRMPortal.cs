namespace Terrasoft.Configuration
{
	...
	public class PartnershipInTagSchema : Terrasoft.Configuration.PartnershipInTag_PRMBase_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePartnershipInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePartnershipInTagEventsProcessSchema() {
			var schema = new PartnershipInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: PartnershipInTagEventsProcessSchema

	/// <exclude/>
	public class PartnershipInTagEventsProcessSchema : Terrasoft.Configuration.PartnershipInTag_PRMBase_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public PartnershipInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PartnershipInTagEventsProcessSchema(PartnershipInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "PartnershipInTag_PRMPortalEventsProcess";
			UId = new Guid("935980a0-2d4b-430e-b3a7-f285094cab5b");
		...
		public override object Clone() {
			return new PartnershipInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("935980a0-2d4b-430e-b3a7-f285094cab5b"));
		}
