namespace Terrasoft.Configuration
{
	...
	public class FileSchema : Terrasoft.Configuration.File_LinkPreview_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateFileEventsProcessSchema() {
			var schema = new FileEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: FileEventsProcessSchema

	/// <exclude/>
	public class FileEventsProcessSchema : Terrasoft.Configuration.File_LinkPreview_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public FileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public FileEventsProcessSchema(FileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "File_PRMPortalEventsProcess";
			UId = new Guid("84c38674-6336-4d4b-8398-5ae20c73c912");
			CreatedInPackageId = new Guid("1bc37faf-30bf-4d4a-b067-5fd52b4ccffd");
		...
		public override object Clone() {
			return new FileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("84c38674-6336-4d4b-8398-5ae20c73c912"));
		}
