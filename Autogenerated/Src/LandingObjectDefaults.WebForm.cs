namespace Terrasoft.Configuration
{
	...
	public class LandingObjectDefaultsSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new LandingObjectDefaults_WebFormEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class LandingObjectDefaults_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : LandingObjectDefaults
	{
