namespace Terrasoft.Configuration
{
	...
	public class EventTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEventTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEventTagEventsProcessSchema() {
			var schema = new EventTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new EventTag_MarketingCampaignEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class EventTag_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : EventTag
	{
	...
	#region Class: EventTagEventsProcessSchema

	/// <exclude/>
	public class EventTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public EventTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EventTagEventsProcessSchema(EventTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EventTag_MarketingCampaignEventsProcess";
			UId = new Guid("4e054615-8513-4ab3-8a65-d057e3e8a279");
			CreatedInPackageId = new Guid("2021144c-d253-4633-b839-0b16338ac88e");
		...
		public override object Clone() {
			return new EventTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("4e054615-8513-4ab3-8a65-d057e3e8a279"));
		}
