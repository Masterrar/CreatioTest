namespace Terrasoft.Configuration
{
	...
	public class VwDocumentProductSchema : Terrasoft.Configuration.DocumentProductSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwDocumentProduct_DocumentEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwDocumentProduct_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.DocumentProduct_DocumentEventsProcess<TEntity> where TEntity : VwDocumentProduct
	{
