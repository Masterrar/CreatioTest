namespace Terrasoft.Configuration
{
	...
	public class CampaignPlannerInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignPlannerInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignPlannerInTagEventsProcessSchema() {
			var schema = new CampaignPlannerInTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignPlannerInTag_CampaignPlannerNewEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignPlannerInTag_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : CampaignPlannerInTag
	{
	...
	#region Class: CampaignPlannerInTagEventsProcessSchema

	/// <exclude/>
	public class CampaignPlannerInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignPlannerInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignPlannerInTagEventsProcessSchema(CampaignPlannerInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignPlannerInTag_CampaignPlannerNewEventsProcess";
			UId = new Guid("dbfb6076-2095-4797-a19a-4fed79d33255");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new CampaignPlannerInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("dbfb6076-2095-4797-a19a-4fed79d33255"));
		}
