namespace Terrasoft.Configuration
{
	...
	public class CampaignLogStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignLogStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignLogStatusEventsProcessSchema() {
			var schema = new CampaignLogStatusEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignLogStatus_CampaignsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignLogStatus_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignLogStatus
	{
	...
	#region Class: CampaignLogStatusEventsProcessSchema

	/// <exclude/>
	public class CampaignLogStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignLogStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignLogStatusEventsProcessSchema(CampaignLogStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignLogStatus_CampaignsEventsProcess";
			UId = new Guid("c27c1c32-e401-40ba-b7e8-e56fc1f8839d");
			CreatedInPackageId = new Guid("bac310da-8f6a-4932-87be-74eb3d9d7067");
		...
		public override object Clone() {
			return new CampaignLogStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c27c1c32-e401-40ba-b7e8-e56fc1f8839d"));
		}
