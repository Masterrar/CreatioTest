namespace Terrasoft.Configuration
{
	...
	public class EmailTemplateSendFlagSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new EmailTemplateSendFlag_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class EmailTemplateSendFlag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EmailTemplateSendFlag
	{
