namespace Terrasoft.Configuration
{
	...
	public class ProductType_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProductType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProductType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ProductType_Base_Terrasoft
	{
