namespace Terrasoft.Configuration
{
	...
	public class Product_Base_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Product_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Product_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Product_Base_Terrasoft
	{
