namespace Terrasoft.Configuration
{
	...
	public class TradeMarkSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new TradeMark_ProductCatalogueEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class TradeMark_ProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : TradeMark
	{
