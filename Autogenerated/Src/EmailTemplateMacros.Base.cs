namespace Terrasoft.Configuration
{
	...
	public class EmailTemplateMacros_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEmailTemplateMacros_Base_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEmailTemplateMacros_Base_TerrasoftEventsProcessSchema() {
			var schema = new EmailTemplateMacros_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new EmailTemplateMacros_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class EmailTemplateMacros_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : EmailTemplateMacros_Base_Terrasoft
	{
	...
	#region Class: EmailTemplateMacros_Base_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class EmailTemplateMacros_Base_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public EmailTemplateMacros_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EmailTemplateMacros_Base_TerrasoftEventsProcessSchema(EmailTemplateMacros_Base_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new EmailTemplateMacros_Base_TerrasoftEventsProcessSchema(this);
		}
