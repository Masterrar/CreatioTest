namespace Terrasoft.Configuration
{
	...
	public class LookupFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new LookupFolder_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class LookupFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : LookupFolder
	{
