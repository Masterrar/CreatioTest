namespace Terrasoft.Configuration
{
	...
	public class QuickAddMenuItemSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new QuickAddMenuItem_NUIEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class QuickAddMenuItem_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : QuickAddMenuItem
	{
