namespace Terrasoft.Configuration
{
	...
	public class OpportunityProductInterestSchema : Terrasoft.Configuration.OpportunityProductInterest_Opportunity_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityProductInterestEventsProcessSchema();
		}
	...
	#region Class: OpportunityProductInterestEventsProcessSchema

	/// <exclude/>
	public class OpportunityProductInterestEventsProcessSchema : Terrasoft.Configuration.OpportunityProductInterest_Opportunity_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityProductInterestEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityProductInterest_PRMPortalEventsProcess";
			UId = new Guid("9821444a-de55-43e2-bfdc-66a528e81e3f");
			CreatedInPackageId = new Guid("580620fc-064a-4cdc-95d9-80175a4d3b0d");
			...
			ParentSchemaUId = new Guid("46ad895d-8074-4a95-b13c-df1ab3582c98");
		...
		public override object Clone() {
			return new OpportunityProductInterestEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9821444a-de55-43e2-bfdc-66a528e81e3f"));
		}
