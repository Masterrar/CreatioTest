namespace Terrasoft.Configuration
{
	...
	public class ProblemTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProblemTypeEventsProcessSchema();
		}
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ProblemType_ProblemEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ProblemType_ProblemEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ProblemType
	{
	...
	#region Class: ProblemTypeEventsProcessSchema

	/// <exclude/>
	public class ProblemTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ProblemTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProblemType_ProblemEventsProcess";
			UId = new Guid("5bd5c83e-628b-487c-8a86-8372591aaaae");
			CreatedInPackageId = new Guid("305fcfca-4160-4398-90a9-d5e84be0ae12");
		...
		public override object Clone() {
			return new ProblemTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("5bd5c83e-628b-487c-8a86-8372591aaaae"));
		}
