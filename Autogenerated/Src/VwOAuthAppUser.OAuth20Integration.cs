namespace Terrasoft.Configuration
{
	...
	public class VwOAuthAppUserSchema : Terrasoft.Configuration.OAuthTokenStorageSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new VwOAuthAppUser_OAuth20IntegrationEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class VwOAuthAppUser_OAuth20IntegrationEventsProcess<TEntity> : Terrasoft.Configuration.OAuthTokenStorage_BaseEventsProcess<TEntity> where TEntity : VwOAuthAppUser
	{
