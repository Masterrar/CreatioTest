namespace Terrasoft.Configuration
{
	...
	public class SysModulePrimaryGridSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysModulePrimaryGrid_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysModulePrimaryGrid_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModulePrimaryGrid
	{
