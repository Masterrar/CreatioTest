namespace Terrasoft.Configuration
{
	...
	public class ReleaseTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateReleaseTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateReleaseTypeEventsProcessSchema() {
			var schema = new ReleaseTypeEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ReleaseType_ReleaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ReleaseType_ReleaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ReleaseType
	{
	...
	#region Class: ReleaseTypeEventsProcessSchema

	/// <exclude/>
	public class ReleaseTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ReleaseTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ReleaseTypeEventsProcessSchema(ReleaseTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ReleaseType_ReleaseEventsProcess";
			UId = new Guid("e47a5286-f235-42bc-a885-e04aa848c158");
			CreatedInPackageId = new Guid("6364546f-7b12-440c-84c2-926c09002599");
		...
		public override object Clone() {
			return new ReleaseTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e47a5286-f235-42bc-a885-e04aa848c158"));
		}
