namespace Terrasoft.Configuration
{
	...
	public class SiteEventAttributeTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSiteEventAttributeTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSiteEventAttributeTypeEventsProcessSchema() {
			var schema = new SiteEventAttributeTypeEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SiteEventAttributeType_SiteEventEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SiteEventAttributeType_SiteEventEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SiteEventAttributeType
	{
	...
	#region Class: SiteEventAttributeTypeEventsProcessSchema

	/// <exclude/>
	public class SiteEventAttributeTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SiteEventAttributeTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SiteEventAttributeTypeEventsProcessSchema(SiteEventAttributeTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SiteEventAttributeType_SiteEventEventsProcess";
			UId = new Guid("05722b33-5f4b-427a-be1f-db535317c3d9");
			CreatedInPackageId = new Guid("2a23e39e-fab7-43e0-a89e-cc22e5c8d6ed");
		...
		public override object Clone() {
			return new SiteEventAttributeTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("05722b33-5f4b-427a-be1f-db535317c3d9"));
		}
