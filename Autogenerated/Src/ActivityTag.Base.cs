namespace Terrasoft.Configuration
{
	...
	public class ActivityTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ActivityTag_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ActivityTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ActivityTag
	{
