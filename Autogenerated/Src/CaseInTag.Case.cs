namespace Terrasoft.Configuration
{
	...
	public class CaseInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCaseInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCaseInTagEventsProcessSchema() {
			var schema = new CaseInTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CaseInTag_CaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CaseInTag_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_BaseEventsProcess<TEntity> where TEntity : CaseInTag
	{
	...
	#region Class: CaseInTagEventsProcessSchema

	/// <exclude/>
	public class CaseInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public CaseInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CaseInTagEventsProcessSchema(CaseInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CaseInTag_CaseEventsProcess";
			UId = new Guid("0cb9ea9b-1fac-4e20-b18e-780c3936416a");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new CaseInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0cb9ea9b-1fac-4e20-b18e-780c3936416a"));
		}
