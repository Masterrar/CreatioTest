namespace Terrasoft.Configuration
{
	...
	public class BufferedImportEntitySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BufferedImportEntity_FileImportEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BufferedImportEntity_FileImportEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BufferedImportEntity
	{
