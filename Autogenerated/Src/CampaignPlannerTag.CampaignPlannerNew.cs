namespace Terrasoft.Configuration
{
	...
	public class CampaignPlannerTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignPlannerTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignPlannerTagEventsProcessSchema() {
			var schema = new CampaignPlannerTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignPlannerTag_CampaignPlannerNewEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignPlannerTag_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : CampaignPlannerTag
	{
	...
	#region Class: CampaignPlannerTagEventsProcessSchema

	/// <exclude/>
	public class CampaignPlannerTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignPlannerTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignPlannerTagEventsProcessSchema(CampaignPlannerTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignPlannerTag_CampaignPlannerNewEventsProcess";
			UId = new Guid("e3815989-678c-4ba2-b413-4b900f208289");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new CampaignPlannerTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e3815989-678c-4ba2-b413-4b900f208289"));
		}
