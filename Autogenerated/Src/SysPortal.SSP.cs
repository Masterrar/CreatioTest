namespace Terrasoft.Configuration
{
	...
	public class SysPortalSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysPortal_SSPEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysPortal_SSPEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysPortal
	{
