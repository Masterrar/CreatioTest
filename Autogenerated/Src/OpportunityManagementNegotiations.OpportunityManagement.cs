),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("fe10dd95-2d61-4aa1-8111-9fb23b032603"),
			...
			var releaseParameter = new ProcessSchemaParameter(this) {
				ReferenceSchemaUId = new Guid("0bf3a274-e5da-4fc7-94c4-3ae233598714"),
				UId = new Guid("13fcc47d-a22c-4c51-abf8-4f4283392dd7"),
				ContainerUId = new Guid("5f612011-74fb-45a4-9eda-c793f6ab4386"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("fe10dd95-2d61-4aa1-8111-9fb23b032603"),
		...
		protected virtual void InitializeOpenEditPageUserTask1Parameters(IParametrizedProcessSchemaElement parametrizedElement) {
			...
			var problemParameter = new ProcessSchemaParameter(this) {
				ReferenceSchemaUId = new Guid("7ec5366d-8edf-4b7d-b94b-2bc2655cf230"),
				UId = new Guid("4a151ca8-8daa-48b7-9e14-e17da01145b6"),
				ContainerUId = new Guid("53eae2f8-1581-44f5-844f-21585ca3c05c"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b0d3ad9f-7a27-46a3-9483-ed70c26872ae"),
			...
			var changeParameter = new ProcessSchemaParameter(this) {
				ReferenceSchemaUId = new Guid("de5c8d59-d372-407d-8c09-f0523e057e40"),
				UId = new Guid("7b159b33-afcc-4db8-b658-2255087850a2"),
				ContainerUId = new Guid("53eae2f8-1581-44f5-844f-21585ca3c05c"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b0d3ad9f-7a27-46a3-9483-ed70c26872ae"),
			...
			var releaseParameter = new ProcessSchemaParameter(this) {
				ReferenceSchemaUId = new Guid("0bf3a274-e5da-4fc7-94c4-3ae233598714"),
				UId = new Guid("4f70c5bd-70fa-40e1-bb9e-174838bb28ff"),
				ContainerUId = new Guid("53eae2f8-1581-44f5-844f-21585ca3c05c"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b0d3ad9f-7a27-46a3-9483-ed70c26872ae"),
			...
			var projectParameter = new ProcessSchemaParameter(this) {
				ReferenceSchemaUId = new Guid("a11d7fa4-9946-494c-ae41-2169844d29be"),
				UId = new Guid("5a86c9ef-fd86-4854-a460-432f4cb2bbc3"),
				ContainerUId = new Guid("53eae2f8-1581-44f5-844f-21585ca3c05c"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b0d3ad9f-7a27-46a3-9483-ed70c26872ae"),
		...
		protected virtual void InitializeOpenEditPageUserTask2Parameters(IParametrizedProcessSchemaElement parametrizedElement) {
			...
			var problemParameter = new ProcessSchemaParameter(this) {
				ReferenceSchemaUId = new Guid("7ec5366d-8edf-4b7d-b94b-2bc2655cf230"),
				UId = new Guid("73c5eec5-d8aa-4616-a463-924d1ff27fd9"),
				ContainerUId = new Guid("f0f669ff-3b96-4f84-a801-cebcb5da9e69"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b0d3ad9f-7a27-46a3-9483-ed70c26872ae"),
			...
			var changeParameter = new ProcessSchemaParameter(this) {
				ReferenceSchemaUId = new Guid("de5c8d59-d372-407d-8c09-f0523e057e40"),
				UId = new Guid("90307f6d-3370-4629-ad4a-4e6cfb68db98"),
				ContainerUId = new Guid("f0f669ff-3b96-4f84-a801-cebcb5da9e69"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b0d3ad9f-7a27-46a3-9483-ed70c26872ae"),
			...
			var releaseParameter = new ProcessSchemaParameter(this) {
				ReferenceSchemaUId = new Guid("0bf3a274-e5da-4fc7-94c4-3ae233598714"),
				UId = new Guid("e9846686-e3ee-4454-9235-78d29e8fe3fd"),
				ContainerUId = new Guid("f0f669ff-3b96-4f84-a801-cebcb5da9e69"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b0d3ad9f-7a27-46a3-9483-ed70c26872ae"),
			...
			var projectParameter = new ProcessSchemaParameter(this) {
				ReferenceSchemaUId = new Guid("a11d7fa4-9946-494c-ae41-2169844d29be"),
				UId = new Guid("bd1d5aff-64f9-4d2a-91be-ae9ed49e4254"),
				ContainerUId = new Guid("f0f669ff-3b96-4f84-a801-cebcb5da9e69"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("b0d3ad9f-7a27-46a3-9483-ed70c26872ae"),
	...
	public class OpportunityManagementNegotiations : Terrasoft.Core.Process.Process
	{
			...
			public override LocalizableString BranchingDecisions {
				get {
					if (_branchingDecisions == null) {
						var zippedData = new byte[] { 31,139,8,0,0,0,0,0,4,0,157,143,177,106,195,48,16,64,127,165,136,140,190,32,217,103,75,206,154,80,8,132,146,33,205,82,58,156,164,51,53,117,234,32,57,133,38,248,223,43,167,75,66,161,67,55,193,187,119,167,119,17,179,225,235,200,98,33,118,28,2,197,190,25,230,203,62,240,124,27,122,199,49,206,55,189,163,174,61,147,237,120,75,129,14,60,112,216,83,119,226,184,105,227,144,61,220,107,34,19,179,207,43,21,139,151,139,88,15,124,120,94,251,180,29,169,105,84,238,11,144,104,21,160,205,53,16,107,4,99,140,55,72,53,90,175,146,60,205,94,196,117,67,146,116,93,26,76,38,88,82,26,80,121,6,91,26,11,232,141,116,42,151,214,73,45,198,76,60,165,111,221,122,43,118,109,108,251,15,57,193,37,29,135,244,158,120,27,55,238,188,255,25,26,194,137,19,93,113,179,124,99,247,206,119,135,119,9,138,113,204,110,11,12,123,173,29,50,40,197,117,42,160,18,172,175,115,240,21,34,42,162,18,155,250,87,1,26,89,20,44,43,48,5,73,192,170,172,192,86,142,192,235,50,199,130,170,90,106,247,87,129,250,111,193,35,117,113,74,120,29,191,1,0,93,212,131,226,1,0,0 };
		...
		private void OnExecuted(object sender, ProcessActivityAfterEventArgs e) {
			switch (e.Context.SenderName) {
					...
					case "ActivityUserTask2":
						if (ActivityUserTask2.ActivityResult == new Guid("dbbf0e10-f46b-1410-6598-00155d043204") || ActivityUserTask2.ActivityResult == new Guid("632afdd2-f616-4ea6-87d2-8ed38eed8aff")) {
							e.Context.QueueTasksV2.Enqueue(new ProcessQueueElement("Terminate1", e.Context.SenderName));
							break;
						}
						break;
					case "UserQuestionUserTask1":
						if (System.Linq.Enumerable.Count(System.Linq.Enumerable.Intersect(JsonConvert.DeserializeObject<Collection<Guid>>(UserQuestionUserTask1.ResultDecisions), ConditionalFlow1.ProcessActivitiesSelectedResults[new Guid("5f612011-74fb-45a4-9eda-c793f6ab4386")])) != 0) {
		...
		protected override void InitializeMetaPathParameterValues() {
			...
			MetaPathParameterValues.Add("0a5f29c7-3339-471e-af41-8b573733e857", () => ActivityUserTask2.Project);
			MetaPathParameterValues.Add("1708c49d-d586-43c0-b39e-11c74bfc43f6", () => ActivityUserTask2.Problem);
			MetaPathParameterValues.Add("da649928-3e4b-44a4-b174-ce8f8d92e911", () => ActivityUserTask2.Change);
			MetaPathParameterValues.Add("83cc43ef-ff52-4d2a-84c9-1ef908279d43", () => ActivityUserTask2.Release);
			MetaPathParameterValues.Add("2d0b0e33-7ec5-4029-94df-8b8b10420d0d", () => ActivityUserTask2.QueueItem);
			MetaPathParameterValues.Add("b5313a8c-d745-418a-b820-4b883839208a", () => ActivityUserTask2.Application);
			MetaPathParameterValues.Add("82942c4a-797b-479d-95ab-f64ee5ed489f", () => ActivityUserTask2.FinApplication);
			...
			MetaPathParameterValues.Add("b035ed0e-14f5-45a3-87f3-8982d05a613f", () => UserQuestionUserTask1.Project);
			MetaPathParameterValues.Add("51784516-6f47-49b5-8f80-e603d5cec8cd", () => UserQuestionUserTask1.Problem);
			MetaPathParameterValues.Add("ae39820e-1ea9-4e62-a000-4d86beac9e9b", () => UserQuestionUserTask1.Change);
			MetaPathParameterValues.Add("13fcc47d-a22c-4c51-abf8-4f4283392dd7", () => UserQuestionUserTask1.Release);
			...
			MetaPathParameterValues.Add("4a151ca8-8daa-48b7-9e14-e17da01145b6", () => OpenEditPageUserTask1.Problem);
			MetaPathParameterValues.Add("7b159b33-afcc-4db8-b658-2255087850a2", () => OpenEditPageUserTask1.Change);
			MetaPathParameterValues.Add("4f70c5bd-70fa-40e1-bb9e-174838bb28ff", () => OpenEditPageUserTask1.Release);
			MetaPathParameterValues.Add("5a86c9ef-fd86-4854-a460-432f4cb2bbc3", () => OpenEditPageUserTask1.Project);
			...
			MetaPathParameterValues.Add("73c5eec5-d8aa-4616-a463-924d1ff27fd9", () => OpenEditPageUserTask2.Problem);
			MetaPathParameterValues.Add("90307f6d-3370-4629-ad4a-4e6cfb68db98", () => OpenEditPageUserTask2.Change);
			MetaPathParameterValues.Add("e9846686-e3ee-4454-9235-78d29e8fe3fd", () => OpenEditPageUserTask2.Release);
			MetaPathParameterValues.Add("bd1d5aff-64f9-4d2a-91be-ae9ed49e4254", () => OpenEditPageUserTask2.Project);
		}
