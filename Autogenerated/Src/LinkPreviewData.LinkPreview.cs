namespace Terrasoft.Configuration
{
	...
	public class LinkPreviewDataSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new LinkPreviewData_LinkPreviewEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class LinkPreviewData_LinkPreviewEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : LinkPreviewData
	{
