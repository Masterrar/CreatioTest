namespace Terrasoft.Configuration
{
	...
	public class InvoicePaymentStatus_Invoice_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new InvoicePaymentStatus_InvoiceEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class InvoicePaymentStatus_InvoiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : InvoicePaymentStatus_Invoice_Terrasoft
	{
