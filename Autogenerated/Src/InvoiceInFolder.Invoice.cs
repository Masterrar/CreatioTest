namespace Terrasoft.Configuration
{
	...
	public class InvoiceInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new InvoiceInFolder_InvoiceEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class InvoiceInFolder_InvoiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_BaseEventsProcess<TEntity> where TEntity : InvoiceInFolder
	{
