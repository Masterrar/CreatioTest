namespace Terrasoft.Configuration
{
	...
	public class MonthSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Month_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Month_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : Month
	{
