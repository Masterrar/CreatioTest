namespace Terrasoft.Configuration.ML
{
	...
	public interface IMLModelQueryBuilder
	{
		...
		Select BuildSelect(Guid rootSchemaUId, string queryExpression, IEnumerable<ColumnExpression> columnExpressions,
		...
		/// </returns>
		Dictionary<string, ColumnExpression> GetColumnExpressionMapping(Guid rootSchemaUId, string queryExpression,
			IEnumerable<ColumnExpression> columnExpressions);
	...
	public class MLModelQueryBuilder : IMLModelQueryBuilder
	{
		...
		private ISelectQueryBuilder ConstructSelectQueryBuilder(Guid rootSchemaUId, string queryExpression,
				IEnumerable<ColumnExpression> columnExpressions, byte[] filterData,
		...
		public Select BuildSelect(Guid rootSchemaUId, string queryExpression,
				IEnumerable<ColumnExpression> columnExpressions, byte[] filterData = null,
		...
		public Dictionary<string, ColumnExpression> GetColumnExpressionMapping(Guid rootSchemaUId,
				string queryExpression, IEnumerable<ColumnExpression> columnExpressions) {
