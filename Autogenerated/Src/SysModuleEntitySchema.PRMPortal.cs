namespace Terrasoft.Configuration
{
	...
	public class SysModuleEntitySchema : Terrasoft.Configuration.SysModuleEntity_Base_TerrasoftSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysModuleEntity_PRMPortalEventsProcess(userConnection);
		}
	...
	public class SysModuleEntity : Terrasoft.Configuration.SysModuleEntity_Base_Terrasoft
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysModuleEntity_PRMPortalEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysModuleEntity_PRMPortalEventsProcess

	/// <exclude/>
	public partial class SysModuleEntity_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.SysModuleEntity_BaseEventsProcess<TEntity> where TEntity : SysModuleEntity
	{

		public SysModuleEntity_PRMPortalEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysModuleEntity_PRMPortalEventsProcess";
	...
	/// <exclude/>
	public class SysModuleEntity_PRMPortalEventsProcess : SysModuleEntity_PRMPortalEventsProcess<SysModuleEntity>
	{
	...
	public partial class SysModuleEntity_PRMPortalEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysModuleEntityEventsProcess : SysModuleEntity_PRMPortalEventsProcess
	{
