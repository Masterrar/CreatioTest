namespace Terrasoft.Configuration
{
	...
	public class ServiceItemTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateServiceItemTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateServiceItemTagEventsProcessSchema() {
			var schema = new ServiceItemTagEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ServiceItemTag_SLMEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ServiceItemTag_SLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ServiceItemTag
	{
	...
	#region Class: ServiceItemTagEventsProcessSchema

	/// <exclude/>
	public class ServiceItemTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public ServiceItemTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ServiceItemTagEventsProcessSchema(ServiceItemTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ServiceItemTag_SLMEventsProcess";
			UId = new Guid("617aea5a-a355-4679-a994-88cb8bdab270");
			CreatedInPackageId = new Guid("dfe2c6b5-61e8-4e57-95ae-a3c34fa0908f");
		...
		public override object Clone() {
			return new ServiceItemTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("617aea5a-a355-4679-a994-88cb8bdab270"));
		}
