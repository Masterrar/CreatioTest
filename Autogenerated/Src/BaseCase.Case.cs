namespace Terrasoft.Configuration
{
	...
	public class BaseCaseSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBaseCaseEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBaseCaseEventsProcessSchema() {
			var schema = new BaseCaseEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new BaseCase_CaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class BaseCase_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BaseCase
	{
	...
	#region Class: BaseCaseEventsProcessSchema

	/// <exclude/>
	public class BaseCaseEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public BaseCaseEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BaseCaseEventsProcessSchema(BaseCaseEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BaseCase_CaseEventsProcess";
			UId = new Guid("c732b900-2d9a-4129-96fa-06c57b24c6ea");
			CreatedInPackageId = new Guid("e9cdff4a-a92d-4d26-906f-df90167f5485");
		...
		public override object Clone() {
			return new BaseCaseEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c732b900-2d9a-4129-96fa-06c57b24c6ea"));
		}
