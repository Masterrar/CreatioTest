namespace Terrasoft.Configuration
{
	...
	public class EmailTemplateRecipientTypeSchema : Terrasoft.Configuration.SysCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new EmailTemplateRecipientType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class EmailTemplateRecipientType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.SysCodeLookup_BaseEventsProcess<TEntity> where TEntity : EmailTemplateRecipientType
	{
