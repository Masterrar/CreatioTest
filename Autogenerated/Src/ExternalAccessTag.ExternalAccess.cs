namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ExternalAccessTag_ExternalAccessEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : ExternalAccessTag
	{
