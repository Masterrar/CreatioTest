	...
	public class CampaignEventHelper
	{
		...
		private Select GetSelectContactsCampaignForEvent(Guid campaignId, Guid eventId, Guid stepId) {
			var select = new Select(_userConnection)
				.Column(Column.Const(eventId)).As("EventId")
				.Column(Column.Const(MarketingConsts.EventResponsePlannedId)).As("EventResponseId")
				.Column(Column.Const(false)).As("IsFromGroup")
