namespace Terrasoft.Configuration.DynamicContent
{
	...
	public class DCGroupingStrategy : DCSegmentationStrategyBase
	{
		...
		private void ProcessAudienceSegmentation(Guid sessionId, int totalRecipients) {
		...
		public override void SegmentAudience() {
			...
			ProcessAudienceSegmentation(_sessionId, recipientsCount);
		}
