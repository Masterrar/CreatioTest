namespace Terrasoft.Configuration
{
	...
	public class IntegrationLogSettingsSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new IntegrationLogSettings_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class IntegrationLogSettings_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : IntegrationLogSettings
	{
