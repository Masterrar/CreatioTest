namespace Terrasoft.Configuration
{
	...
	public class CallDirectionSchema : Terrasoft.Configuration.BaseCodeImageLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CallDirection_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CallDirection_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeImageLookup_BaseEventsProcess<TEntity> where TEntity : CallDirection
	{
