namespace Terrasoft.Configuration
{
	...
	public class CampaignSignalEntitySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignSignalEntityEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignSignalEntityEventsProcessSchema() {
			var schema = new CampaignSignalEntityEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignSignalEntity_CampaignElementsEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignSignalEntity_CampaignElementsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CampaignSignalEntity
	{
	...
	#region Class: CampaignSignalEntityEventsProcessSchema

	/// <exclude/>
	public class CampaignSignalEntityEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignSignalEntityEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignSignalEntityEventsProcessSchema(CampaignSignalEntityEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignSignalEntity_CampaignElementsEventsProcess";
			UId = new Guid("e753d98c-7152-4d0b-aa6a-87fe7488ac15");
			CreatedInPackageId = new Guid("d0bba11f-3986-4819-81ab-1d3ddbfc1f48");
		...
		public override object Clone() {
			return new CampaignSignalEntityEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e753d98c-7152-4d0b-aa6a-87fe7488ac15"));
		}
