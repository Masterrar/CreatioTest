namespace Terrasoft.Configuration
{
	...
	public class AccountTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new AccountTag_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class AccountTag_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : AccountTag
	{
