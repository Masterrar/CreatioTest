namespace Terrasoft.Configuration
{
	...
	public class DistributionTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new DistributionType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class DistributionType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : DistributionType
	{
