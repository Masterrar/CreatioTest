...
#region CRM-42481 Адаптировать Terrasoft.Social.OAuth
...
namespace Terrasoft.Social.OAuth
{
	...
	public abstract class OAuthAuthenticator : BaseService, IOAuthAuthenticator
	{
		...
		protected virtual HttpRequestBase Request { get; set; }
		protected virtual HttpResponseBase Response { get; set; }
		...
		protected string BpmDomainApplicationUrl { get; set; }
		protected Dictionary<string, string> AditionalUrlParams { get; set; }
		public Dictionary<string, object> State { get; set; }
		public virtual string RedirectUrl { get; set; }
		public virtual string FinalStageRedirectUrl { get; set; }
		...
		protected virtual OAuthUserCredentials GetOAuthUserCredentials(string response) { return null; }
		protected virtual OAuthUserCredentials UpdateUserCredentials(OAuthUserCredentials credentials,
				string response) { return null; }
		protected virtual void SaveCredentials(OAuthUserCredentials credentials) { }
		protected virtual string GetStateAsString() { return null; }
		protected void AppendCookieToResponse(bool success, JObject values) { }
		protected void AppendError(Exception ex) {  }
		protected virtual JObject GetSuccessResultObject(OAuthUserCredentials credentials) { return null; }
		protected void RedirectToBpm(string bpmUrl) {  }
		protected virtual bool ValidateCredentials(OAuthUserCredentials credentials) { return true; }
		protected virtual byte[] SendRequest(string url, NameValueCollection parameters) {
			return null;
		}
		public virtual string AuthenticateUser(string userLogin) { return null; }
		public virtual void ProcessAuthenticationCode(string code) { }
		public string RefreshAccessToken(string userLogin) { return null; }
	}
}
