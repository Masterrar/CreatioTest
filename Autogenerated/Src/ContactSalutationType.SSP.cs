namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ContactSalutationType_SSPEventsProcess<TEntity> : Terrasoft.Configuration.ContactSalutationType_BaseEventsProcess<TEntity> where TEntity : ContactSalutationType
	{
