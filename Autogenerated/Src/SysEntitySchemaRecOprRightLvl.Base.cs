namespace Terrasoft.Configuration
{
	...
	public class SysEntitySchemaRecOprRightLvlSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysEntitySchemaRecOprRightLvl_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysEntitySchemaRecOprRightLvl_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SysEntitySchemaRecOprRightLvl
	{
