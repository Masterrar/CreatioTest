namespace Terrasoft.Configuration
{
	...
	public class CampaignPlannerStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignPlannerStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignPlannerStatusEventsProcessSchema() {
			var schema = new CampaignPlannerStatusEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignPlannerStatus_CampaignPlannerNewEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignPlannerStatus_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : CampaignPlannerStatus
	{
	...
	#region Class: CampaignPlannerStatusEventsProcessSchema

	/// <exclude/>
	public class CampaignPlannerStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignPlannerStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignPlannerStatusEventsProcessSchema(CampaignPlannerStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignPlannerStatus_CampaignPlannerNewEventsProcess";
			UId = new Guid("8fcf7418-0974-416b-a965-caeafecc3ee4");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new CampaignPlannerStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("8fcf7418-0974-416b-a965-caeafecc3ee4"));
		}
