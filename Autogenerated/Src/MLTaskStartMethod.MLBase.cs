namespace Terrasoft.Configuration
{
	...
	public class MLTaskStartMethodSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new MLTaskStartMethod_MLBaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class MLTaskStartMethod_MLBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : MLTaskStartMethod
	{
