namespace Terrasoft.Configuration
{
	...
	public class EduActivityResultSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEduActivityResultEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEduActivityResultEventsProcessSchema() {
			var schema = new EduActivityResultEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: EduActivityResultEventsProcessSchema

	/// <exclude/>
	public class EduActivityResultEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public EduActivityResultEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EduActivityResultEventsProcessSchema(EduActivityResultEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EduActivityResult_PRMBaseEventsProcess";
			UId = new Guid("a8053e99-1f15-413f-8c30-48ba82a18659");
			CreatedInPackageId = new Guid("867b9a25-86bf-4a3e-8ecd-b6e40f57be82");
		...
		public override object Clone() {
			return new EduActivityResultEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a8053e99-1f15-413f-8c30-48ba82a18659"));
		}
