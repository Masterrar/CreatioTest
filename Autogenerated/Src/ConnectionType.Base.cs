namespace Terrasoft.Configuration
{
	...
	public class ConnectionTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new ConnectionType_BaseEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class ConnectionType_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : ConnectionType
	{
