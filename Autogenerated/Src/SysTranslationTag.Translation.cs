namespace Terrasoft.Configuration
{
	...
	public class SysTranslationTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new SysTranslationTag_TranslationEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class SysTranslationTag_TranslationEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : SysTranslationTag
	{
