namespace Terrasoft.Configuration
{
	...
	public class Lead_OrderLead_TerrasoftSchema : Terrasoft.Configuration.Lead_PRMPortal_TerrasoftSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new Lead_OrderLeadEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class Lead_OrderLeadEventsProcess<TEntity> : Terrasoft.Configuration.Lead_PRMPortalEventsProcess<TEntity> where TEntity : Lead_OrderLead_Terrasoft
	{
