namespace Terrasoft.Configuration
{
	...
	public class CompetenceLevelSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCompetenceLevelEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCompetenceLevelEventsProcessSchema() {
			var schema = new CompetenceLevelEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: CompetenceLevelEventsProcessSchema

	/// <exclude/>
	public class CompetenceLevelEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public CompetenceLevelEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CompetenceLevelEventsProcessSchema(CompetenceLevelEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CompetenceLevel_PRMBaseEventsProcess";
			UId = new Guid("3769b81d-c8e0-4ddd-8f18-50404b18e1c6");
			CreatedInPackageId = new Guid("867b9a25-86bf-4a3e-8ecd-b6e40f57be82");
		...
		public override object Clone() {
			return new CompetenceLevelEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("3769b81d-c8e0-4ddd-8f18-50404b18e1c6"));
		}
