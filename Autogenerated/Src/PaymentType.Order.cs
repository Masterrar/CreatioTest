namespace Terrasoft.Configuration
{
	...
	public class PaymentTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new PaymentType_OrderEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class PaymentType_OrderEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : PaymentType
	{
