namespace Terrasoft.Configuration
{
    ...
    public partial class Order_OrderEventsProcess<TEntity>
	{
		...
		public virtual CurrencyRateInfo GetCurrencyInfo() {
			...
			var currencyRateStorage = Terrasoft.Core.Factories.ClassFactory.Get<ICurrenciesRateStorage>();
		...
		public virtual bool CalculatePrimaryAmount() {
            var orderCalculator = Core.Factories.ClassFactory.Get<OrderCalculator>();
