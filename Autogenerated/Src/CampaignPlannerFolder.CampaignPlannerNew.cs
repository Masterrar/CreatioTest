namespace Terrasoft.Configuration
{
	...
	public class CampaignPlannerFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCampaignPlannerFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCampaignPlannerFolderEventsProcessSchema() {
			var schema = new CampaignPlannerFolderEventsProcessSchema(ProcessSchemaManager, this);
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnnection) {
			return 
			new CampaignPlannerFolder_CampaignPlannerNewEventsProcess(userConnnection);
		}
	...
	/// <exclude/>
	public class CampaignPlannerFolder_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : CampaignPlannerFolder
	{
	...
	#region Class: CampaignPlannerFolderEventsProcessSchema

	/// <exclude/>
	public class CampaignPlannerFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public CampaignPlannerFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CampaignPlannerFolderEventsProcessSchema(CampaignPlannerFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CampaignPlannerFolder_CampaignPlannerNewEventsProcess";
			UId = new Guid("9041a474-4c66-4fc3-ac4c-4821c09c5958");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new CampaignPlannerFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9041a474-4c66-4fc3-ac4c-4821c09c5958"));
		}
