namespace Terrasoft.Configuration
{
	...
	public class VwServiceRecepientsSchema : Terrasoft.Configuration.VwServiceRecepients_SLMITILService_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwServiceRecepientsEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwServiceRecepientsEventsProcessSchema() {
			var schema = new VwServiceRecepientsEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public class VwServiceRecepients_PortalITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.VwServiceRecepients_SLMITILServiceEventsProcess<TEntity> where TEntity : VwServiceRecepients
	{
	...
	#region Class: VwServiceRecepientsEventsProcessSchema

	/// <exclude/>
	public class VwServiceRecepientsEventsProcessSchema : Terrasoft.Configuration.VwServiceRecepients_SLMITILService_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public VwServiceRecepientsEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwServiceRecepientsEventsProcessSchema(VwServiceRecepientsEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwServiceRecepients_PortalITILServiceEventsProcess";
			UId = new Guid("655cdb87-4621-4961-af9b-077d21ecaba7");
			CreatedInPackageId = new Guid("f86380cb-7b6d-4263-829e-bbe3aca599d6");
			...
			ParentSchemaUId = new Guid("444dd80b-bbf3-4171-ad88-d59b3a659b00");
		...
		public override object Clone() {
			return new VwServiceRecepientsEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("655cdb87-4621-4961-af9b-077d21ecaba7"));
		}
