namespace Terrasoft.Configuration
{
	...
	public class StatusOfActivitySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateStatusOfActivityEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateStatusOfActivityEventsProcessSchema() {
			var schema = new StatusOfActivityEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: StatusOfActivityEventsProcessSchema

	/// <exclude/>
	public class StatusOfActivityEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public StatusOfActivityEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public StatusOfActivityEventsProcessSchema(StatusOfActivityEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "StatusOfActivity_PRMBaseEventsProcess";
			UId = new Guid("c18ca940-f0a3-48f5-8cf4-b4f0df467fa4");
			CreatedInPackageId = new Guid("867b9a25-86bf-4a3e-8ecd-b6e40f57be82");
		...
		public override object Clone() {
			return new StatusOfActivityEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c18ca940-f0a3-48f5-8cf4-b4f0df467fa4"));
		}
